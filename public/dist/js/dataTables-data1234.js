...
//         $('<td><span class="form-check"><input type="checkbox" name="checkeds[]" value="{{ $company->id }}" class="cked form-check-input" id="chk_sel_'+tdCnt+'"><label class="form-check-label" for="chk_sel_'+tdCnt+'"></label></span></td>').prependTo($(this));
//         tdCnt++;
//     });
	/*DataTable Init*/
	var targetDt0 = $('#datable_4c').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		language: { search: "",
	...
	$('#datable_4c_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt1 = $('#datable_4c1').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
	...
	$('#datable_4c1_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt2 = $('#datable_4c2').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
	...
	$('#datable_4c2_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt3 = $('#datable_4c3').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
	...
	$('#datable_4c3_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt4 = $('#datable_4c4').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
	...
	$('#datable_4c4_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt5 = $('#datable_4c5').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
	...
	$('#datable_4c5_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');

    var targetDt6 = $('#datable_4c6').DataTable({
		scrollX:  true,
		autoWidth: false,
		dom: 'Bfrtip',
		"columnDefs": [ {
	...
	$('#datable_4c6_wrapper .dt-buttons > .btn').addClass('btn-outline-light btn-sm');
	...
	var targetDt222 = $('#datable_10').DataTable({
		scrollX:  true,
		autoWidth: false,
		language: { search: "",
		searchPlaceholder: "Search",
