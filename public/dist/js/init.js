...
var jampack = function(){
    ...
    //     let hoverTimeout;
    //     $(document).on('mouseenter', '[data-layout="twocolumn"] .main-menu .menu-content-wrap .nav-link', function () {
    //         clearTimeout(hoverTimeout); // Clear any pending hide timeout
    //         var $wrapper = $('[data-layout="twocolumn"]'); // Reference the main layout wrapper
    //         var targetId = $(this).data('target'); // Get the target submenu ID
    //         if (targetId) {
    ...
    //         }
    //     });
    //     $(document).on('mouseenter', '.sub-menu .subnav-list', function () {
    //         clearTimeout(hoverTimeout); // Prevent hiding the submenu
    //         $('[data-layout="twocolumn"]').attr('data-submenu', 'active');
    //     });
    //     $(document).on('mouseleave', '[data-layout="twocolumn"] .main-menu .menu-content-wrap .nav-link, .sub-menu .subnav-list', function () {
    //         hoverTimeout = setTimeout(function () {
    //             $('[data-layout="twocolumn"]').removeAttr('data-submenu');
    //             $(".sub-menu .subnav-list").removeClass('d-flex');
    //         }, 150); // Delay to allow smoother interactions
    //     });
    // });
