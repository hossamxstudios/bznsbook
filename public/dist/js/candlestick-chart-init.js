...
var chart = new ApexCharts(document.querySelector("#cs_chart_1"), options);
chart.render();
...
var chart1 = new ApexCharts(document.querySelector("#cs_chart_2"), options1);
chart1.render();
...
var chartBar = new ApexCharts(document.querySelector("#cs_bar_chart"), optionsBar);
chartBar.render();
