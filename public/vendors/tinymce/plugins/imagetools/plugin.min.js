...
!function(p) {
    ...
    }, r = tinymce.util.Tools.resolve("tinymce.PluginManager"), d = tinymce.util.Tools.resolve("tinymce.util.Tools"), o = function() {}, f = function(t) {
        return function() {
            return t
        }
    }, i = f(!1), u = f(!0), a = function() {
        return c
    }, c = (t = function(t) {
        return t.isNone()
    }
    ...
    var w, b, I, T = window.Promise ? window.Promise : (b = (w = function(t) {
    ...
    function j(t) {
        var e = t.src;
        return (0 === e.indexOf("data:") ? k : function n(r) {
    ...
    function k(n) {
        return new T(function(t, e) {
            (function g(t) {
                ...
                if (!n)
                    return v.none();
                for (var r = n[1], o = e[1], i = p.atob(o), u = i.length, a = Math.ceil(u / 1024), c = new Array(a), s = 0; s < a; ++s) {
                    for (var f = 1024 * s, l = Math.min(1024 + f, u), d = new Array(l - f), m = f, h = 0; m < l; ++h,
                    ++m)
                        d[h] = i[m].charCodeAt(0);
                    c[s] = new Uint8Array(d)
                }
                return v.some(new p.Blob(c,{
                    type: r
                }))
            }
            )(n).fold(function() {
    ...
    function O(t, r, o) {
        ...
        p.HTMLCanvasElement.prototype.toBlob ? new T(function(e, n) {
            t.toBlob(function(t) {
                t ? e(t) : n()
            }, r, o)
        }
        ...
        return e.toCanvas().then(function(t) {
            return function i(t, e, n) {
                var r = m(t.width, t.height)
                  , o = g(r);
                "v" === n ? (o.scale(1, -1),
                o.drawImage(t, 0, -r.height)) : (o.scale(-1, 1),
                o.drawImage(t, -r.width, 0));
                return M(r, e)
            }(t, e.getType(), n)
        })
    }
    ...
    function(t) {
        ...
        fromHtml: function(t, e) {
            ...
            !n.hasChildNodes() || 1 < n.childNodes.length)
                throw p.console.error("HTML does not have a single root node", t),
    ...
    }, J = ("undefined" != typeof p.window ? p.window : Function("return this;")(),
    ...
    ), K = tinymce.util.Tools.resolve("tinymce.util.Delay"), V = tinymce.util.Tools.resolve("tinymce.util.Promise"), W = tinymce.util.Tools.resolve("tinymce.util.URI"), X = function(t) {
    ...
    var Z = function(t) {
      ...
      , rt = function(t) {
        var e, n = (e = t,
        "ImageProxy HTTP error: " + q(et, function(t) {
            return e === t.code
      ...
      , ot = function(t) {
        var e, n, r = function(t) {
            ...
            return e
        }(t), o = (e = ["error", "type"].reduce(function(t, e) {
            return Z(t) ? t[e] : undefined
        }, r),
        Z(e) ? e : null);
        return "ImageProxy Service error: " + (o ? (n = o,
        q(nt, function(t) {
            return t.type === n
      ...
      , ut = function(t, e) {
        ...
        return tt((r = e,
        o = -1 === (n = t).indexOf("?") ? "?" : "&",
        /[?&]apiKey=/.test(n) || !r ? n : n + o + "apiKey=" + encodeURIComponent(r)), i, !1).then(function(t) {
            return t.status < 200 || 300 <= t.status ? (e = t.status,
            n = t.blob,
            400 === (r = e) || 403 === r || 500 === r ? it(0, n) : rt(e)) : V.resolve(t.blob);
            var e, n, r
        })
    };
    var at = function(t, e, n) {
        return e ? ut(t, e) : function r(t, e) {
            return tt(t, {}, e).then(function(t) {
                return t.status < 200 || 300 <= t.status ? rt(t.status) : V.resolve(t.blob)
            })
        }(t, n)
    }
      , ct = 0
      ...
      , lt = function(n, t) {
        var e = function(t) {
            return e = t,
            n.dom.is(e, "img:not([data-mce-object],[data-mce-placeholder])") && (ht(n, t) || gt(n, t) || X(n));
            var e
        };
        return ft(n, t) ? st(t).map(function(t) {
      ...
      , ht = function(t, e) {
        var n = e.src;
        return 0 === n.indexOf("data:") || 0 === n.indexOf("blob:") || new W(n).host === t.documentBaseURI.host
    }
      , gt = function(t, e) {
        return -1 !== d.inArray(t.getParam("imagetools_cors_hosts", [], "string[]"), new W(e.src).host)
    }
      , pt = function(t, e) {
        var n, r, o, i, u = e.src;
        return gt(t, e) ? at(e.src, null, (r = t,
        o = e,
        -1 !== d.inArray(r.getParam("imagetools_credentials_hosts", [], "string[]"), new W(o.src).host))) : ht(t, e) ? j(e) : (u = X(t),
      ...
      , vt = function(t, e) {
        return n = t,
        v.from(n.getParam("imagetools_fetch_image", null, "function")).fold(function() {
            return pt(t, e)
        }, function(t) {
            return t(e)
        });
      ...
      , bt = function(a, c, s, f, l, d) {
        return c.toBlob().then(function(t) {
            var e, n, o, r, i, u = a.editorUpload.blobCache;
            return e = l.src,
            a.getParam("images_reuse_filename", !1, "boolean") && (n = (o = u.getByUri(e)) ? (e = o.uri(),
            o.name()) : (r = a,
            (i = e.match(/\/([^\/\?]+)?\.(?:jpeg|jpg|png|gif)(?:\?|$)/i)) ? r.dom.encode(i[1]) : null)),
            o = u.create({
                id: "imagetools" + ct++,
                blob: t,
                base64: c.toBase64(),
            ...
            a.undoManager.transact(function() {
                a.$(l).on("load", function r() {
                    ...
                    a.$(l).off("load", r),
                    a.nodeChanged(),
                    s ? a.editorUpload.uploadImagesAuto() : (wt(f),
                    t = a,
                    e = f,
                    n = K.setEditorTimeout(t, function() {
      ...
      , It = function(n, r, t, o) {
        return function() {
            return mt(n).fold(function() {
                dt(n, "Could not find selected image")
            }, function(e) {
                return n._scanForImages().then(function() {
                    return yt(n, e.dom())
                }).then(z).then(t).then(function(t) {
      ...
      , Rt = function(e, n, r, i, u) {
        return C(u).then(function(t) {
            var e = Y(t);
            return i.w === e.w && i.h === e.h || Q(r) && function o(t, e) {
                var n, r;
                e && (n = t.style.width,
                r = t.style.height,
                (n || r) && (t.style.width = e.w + "px",
                t.style.height = e.h + "px",
                t.removeAttribute("data-mce-style")),
                n = t.width,
                r = t.height,
                (n || r) && (t.setAttribute("width", e.w),
    ...
    !function At() {
        r.add("imagetools", function(t) {
            var n, e, r, o, i, u, a, c, s = l(0), f = l(null);
            n = t,
            e = s,
            d.each({
