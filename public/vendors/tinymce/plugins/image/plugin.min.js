...
!function(m) {
    "use strict";
    var e, t, n, r, o, a = tinymce.util.Tools.resolve("tinymce.PluginManager"), i = function() {}, l = function(e) {
        return function() {
            return e
        }
    }, s = l(!1), u = l(!0), c = function() {
        return d
    }, d = (e = function(e) {
        return e.isNone()
    }
    ...
    }, S = f("string"), h = f("object"), b = f("array"), v = (r = null,
    function(e) {
        return r === e
    }
    ), y = p("boolean"), w = p("number"), D = Array.prototype.push, x = function(e) {
        ...
        return t
    }, T = Object.prototype.hasOwnProperty, C = (o = function(e, t) {
    ...
    }, O = ("undefined" != typeof m.window ? m.window : Function("return this;")(),
    function(e, t, n) {
        !function(e, t, n) {
            if (!(S(n) || y(n) || w(n)))
                throw m.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", n, ":: Element ", e),
    ...
    }, P = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), L = tinymce.util.Tools.resolve("tinymce.util.Promise"), _ = tinymce.util.Tools.resolve("tinymce.util.XHR"), E = function(e) {
        ...
        return 0 < e.length && /^[0-9]+$/.test(e) && (e += "px"),
        e
    }, j = function(e) {
        if (e.margin) {
    ...
    }, F = P.DOM, G = function(e) {
        return e.style.marginLeft && e.style.marginRight && e.style.marginLeft === e.style.marginRight ? H(e.style.marginLeft) : ""
    }, W = function(e) {
        return e.style.marginTop && e.style.marginBottom && e.style.marginTop === e.style.marginBottom ? H(e.style.marginTop) : ""
    }, q = function(e) {
        ...
        F.insertAfter(n, t),
        n.appendChild(t),
        n.appendChild(F.create("figcaption", {
        ...
        var n = e.getAttribute("style")
          , r = t(null !== n ? n : "");
        0 < r.length ? (e.setAttribute("style", r),
        e.setAttribute("data-mce-style", r)) : e.removeAttribute("style")
    }, Q = function(e, r) {
        return function(e, t, n) {
            e.style[t] ? (e.style[t] = k(n),
            Z(e, r)) : V(e, t, n)
        }
    }, Y = function(e, t) {
        ...
        ue(n, o, t, "class", V),
        ue(n, o, t, "style", me(function(e, t) {
            return V(e, "style", t)
        }, e)),
        ...
        var n = function(e, t) {
            ...
            t.caption) {
                var r = F.create("figure", {
                    "class": "image"
                });
                return r.appendChild(n),
                r.appendChild(F.create("figcaption", {
                    contentEditable: "true"
                }, "Caption")),
        ...
        if (t.dom.setAttrib(r, "data-mce-id", null),
        ae(r)) {
            var a = pe(t, r);
        ...
        ae(l.parentNode)) {
            var s = l.parentNode;
            pe(t, s),
            t.selection.select(l.parentNode)
        } else
            ...
            o = function() {
                ...
                r.selection && (r.selection.select(i),
                r.nodeChanged())
            }
            ,
            (i = l).onload = function() {
                a.width || a.height || !E(r) || r.dom.setAttribs(i, {
        ...
        return void 0 === t && (t = ye),
        function(e) {
            return e ? A.from(e).map(function(e) {
                return we(e, t)
            }) : A.none()
        }
    }, Ae = function(e, n) {
    ...
    var Ue = function(e) {
      ...
      , Oe = function(r) {
        var t, e, a = Se(function(e) {
            ...
            ,
            "string" == typeof (e = r.getParam("image_list", !1)) ? _.send({
                url: e,
                success: function(e) {
                    n(JSON.parse(e))
                }
      ...
      , Me = function(e, t) {
        ...
        n = e,
        r = a.src.value,
        (/^(?:[a-zA-Z]+:)?\/\//.test(r) ? A.none() : n.prependURL.bind(function(e) {
      ...
      , Re = function(e, t) {
        var n, r, a, i = t.getData(), o = i.src.meta;
        if (o !== undefined) {
            var l = C({}, i);
            r = l,
            a = o,
            ...
            n.hasDimensions && (S(a.width) && (r.dimensions.width = a.width),
            S(a.height) && (r.dimensions.height = a.height)),
            S(a["class"]) && Te(n.classList, a["class"]).each(function(e) {
                r.classes = e.value
            }),
            n.hasImageCaption && y(a.caption) && (r.caption = a.caption),
            n.hasAdvTab && (S(a.style) && (r.style = a.style),
      ...
      , ze = function(e, t, n, r) {
        ...
        s = (l = r).getData(),
        u = s.src.value,
        (c = s.src.meta || {}).width || c.height || !i.hasDimensions || a.imageSize(u).then(function(e) {
            o.open && l.setData({
                dimensions: e
            })
        }),
      ...
      , He = function(e, t, n) {
        var r, a, i, o, l, s = j(e(n.style)), u = C({}, n);
        return u.vspace = (r = s)["margin-top"] && r["margin-bottom"] && r["margin-top"] === r["margin-bottom"] ? H(String(r["margin-top"])) : "",
        u.hspace = (a = s)["margin-right"] && a["margin-left"] && a["margin-right"] === a["margin-left"] ? H(String(a["margin-right"])) : "",
      ...
      , ke = function(s, u, t, c) {
        ...
        (0 === (e = n.fileinput).length ? A.none() : A.some(e[0])).fold(function() {
            c.unblock()
        }, function(n) {
            var r, a = m.URL.createObjectURL(n), i = Ce({
                url: u.url,
                basePath: u.basePath,
      ...
      , je = function(h, b, v) {
        return function(e, t) {
            ...
            "src" === t.name ? ze(h, b, v, e) : "images" === t.name ? (c = h,
            m = b,
            d = v,
            f = (g = e).getData(),
            ...
            d.prevImage = p,
            ze(c, m, d, g)) : "alt" === t.name ? v.prevAlt = e.getData().alt : "style" === t.name ? (o = h,
            s = (l = e).getData(),
            u = He(o.parseStyle, o.serializeStyle, s),
            l.setData(u)) : "vspace" === t.name || "hspace" === t.name || "border" === t.name || "borderstyle" === t.name ? (n = h,
            r = e,
            a = C(_e(b.image), r.getData()),
            i = le(n.normalizeCss, Ee(a, !1)),
            r.setData({
                style: i
            })) : "fileinput" === t.name ? ke(h, b, v, e) : "isDecorative" === t.name && (e.getData().isDecorative ? e.disable("alt") : e.enable("alt"))
        }
    }
      , Be = function(i) {
        return function(e) {
            ...
            return {
                ...
                body: (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler ? {
                    type: "tabpanel",
                    tabs: x([[Ne(r)], r.hasAdvTab ? [Ue(r)] : [], r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [Le(r)] : []])
                } : {
                    type: "panel",
                    items: Pe(r)
                },
      ...
      , Fe = function(t) {
        return function(e) {
            return a = t.documentBaseURI.toAbsolute(e),
            new L(function(t) {
                var n = m.document.createElement("img")
                  , r = function(e) {
      ...
      , Ge = function(t) {
        var n, r, a, i, o, l, s, e = {
            ...
            serializeStyle: (n = r = a = i = o = l = t,
            function(e, t) {
                return n.dom.serializeStyle(e, t)
            }
            )
        }, u = function() {
            return Oe(t).then(Be(e)).then(function(e) {
      ...
      , qe = function(i) {
        return function(e) {
            for (var t, n = e.length, r = function(e) {
                ...
                var a = e[n];
                (t = a.attr("class")) && /\bimage\b/.test(t) && (a.attr("contenteditable", i ? "false" : null),
