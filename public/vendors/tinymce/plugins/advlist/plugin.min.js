...
!function() {
    "use strict";
    var n, t, e, r = tinymce.util.Tools.resolve("tinymce.PluginManager"), l = tinymce.util.Tools.resolve("tinymce.util.Tools"), c = function(n, t, e) {
        var r = "UL" === t ? "InsertUnorderedList" : "InsertOrderedList";
        n.execCommand(r, !1, !1 === e ? null : {
            "list-style-type": e
        })
    }, i = function(n) {
        return function() {
    ...
    ,
    {
        ...
        return function(n) {
            return n && /^(OL|UL|DL)$/.test(n.nodeName) && (e = n,
            (t = r).$.contains(t.getBody(), e));
            var t, e
        }
    }, p = function(n, t, e) {
        var r = function(n, t) {
          ...
          , o = -1 !== r ? t.parents.slice(0, r) : t.parents
          , i = l.grep(o, m(n));
        return 0 < i.length && i[0].nodeName === e
    }, y = function(o, n, t, e, r, i) {
    ...
    }, v = function(n, t, e, r, o, i) {
        var u, l, c, s, a;
        1 < i.length ? y(n, t, e, r, o, i) : (l = t,
        c = e,
        s = r,
        a = o,
    ...
    !function O() {
        r.add("advlist", function(n) {
            ...
            i = n,
            u = "lists",
            -1 !== l.inArray(i.getParam("plugins", "", "string").split(/[ ,]/), u) && (v(t = n, "numlist", "Numbered list", "InsertOrderedList", "OL", (r = t.getParam("advlist_number_styles", "default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman")) ? r.split(/[ ,]/) : []),
            v(t, "bullist", "Bullet list", "InsertUnorderedList", "UL", (o = t.getParam("advlist_bullet_styles", "default,circle,square")) ? o.split(/[ ,]/) : []),
