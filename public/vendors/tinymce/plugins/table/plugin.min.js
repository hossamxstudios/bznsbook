...
!function(h) {
    ...
    var e, t, r, o, d = function(e) {
        return function(n) {
            return !e(n)
        }
    }, f = b(!1), C = b(!0), i = function() {
        return c
    }, c = (e = function(n) {
        return n.isNone()
    }
    ,
    {
        ...
        none: i,
        from: function(n) {
            return null === n || n === undefined ? c : a(n)
        }
    }, l = function(r) {
        return function(n) {
            return t = typeof (e = n),
    ...
    }, m = l("string"), g = l("object"), p = l("array"), v = s("boolean"), x = function(n) {
        return !(null === (e = n) || e === undefined);
        var e
    }, T = s("function"), R = s("number"), O = Array.prototype.slice, D = Array.prototype.indexOf, A = Array.prototype.push, B = function(n, e) {
        return t = n,
        r = e,
        -1 < D.call(t, r);
        var t, r
        ...
        return 0 === n.length ? S.none() : S.some(n[n.length - 1])
    }, q = function(n, e) {
        ...
        return S.none()
    }, V = Object.keys, U = Object.hasOwnProperty, K = function(n, e) {
        for (var t = V(n), r = 0, o = t.length; r < o; r++) {
            var u = t[r];
            e(n[u], u)
        }
    }, $ = function(n, t) {
        ...
        return U.call(n, e)
    }, Q = ("undefined" != typeof h.window ? h.window : Function("return this;")(),
    function(n) {
        ...
        return 8 === Z(n) || "#comment" === Q(n)
    }, tn = nn(1), rn = nn(3), on = nn(9), un = nn(11), cn = function(n, e, t) {
        if (!(m(t) || v(t) || R(t)))
            throw h.console.error("Invalid call to Attr.set. Key ", e, ":: Value ", t, ":: Element ", n),
        ...
        return _(n.dom().attributes, function(n, e) {
    ...
    function(n) {
        ...
        fromHtml: function(n, e) {
            var t = (e || h.document).createElement("div");
            if (t.innerHTML = n,
            !t.hasChildNodes() || 1 < t.childNodes.length)
                throw h.console.error("HTML does not have a single root node", n),
                new Error("HTML must have a single root node");
            return Cn(t.childNodes[0])
        },
        fromTag: function(n, e) {
            var t = (e || h.document).createElement(n);
            return Cn(t)
        },
        fromText: function(n, e) {
            var t = (e || h.document).createTextNode(n);
            return Cn(t)
        },
        fromDom: Cn,
        ...
        detect: function(n, e) {
            ...
            return 0 === n.length ? On() : Rn(n, t)
        },
        unknown: On
    }, Bn = "Firefox", In = function(n) {
        var e = n.current
          , t = n.version
          , r = function(n) {
            return function() {
        ...
        firefox: b(Bn),
        safari: b("Safari")
    }, kn = "Windows", En = "Android", Mn = "Solaris", Nn = "FreeBSD", _n = "ChromeOS", Wn = function(n) {
        var e = n.current
          , t = n.version
          , r = function(n) {
            return function() {
        ...
        return zn(n, t).map(function(n) {
            var e = An.detect(n.versionRegexes, t);
            return {
                current: n.name,
                version: e
            }
    ...
    }, Hn = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, qn = function(e) {
        return function(n) {
            return hn(n, e)
        }
    }, Vn = [{
        ...
        var t, r, o, u, i, c, a, l, f, s, d, m, g = Kn.browsers(), p = Kn.oses(), h = Fn(g, n).fold(Pn.unknown, Pn.nu), v = Ln(p, n).fold(jn.unknown, jn.nu);
        return {
            browser: h,
            os: v,
            deviceType: (r = h,
        ...
        return Yn().browser.isIE() ? ne(n, e) : (t = e,
        r = n.dom(),
        o = t.dom(),
        r !== o && r.contains(o));
        var t, r, o
        ...
        for (var t = T(e) ? e : f, r = n.dom(), o = []; null !== r.parentNode && r.parentNode !== undefined; ) {
            var u = r.parentNode
              , i = Sn.fromDom(u);
            if (o.push(i),
            !0 === t(i))
    ...
    }, fe = T(h.Element.prototype.attachShadow) && T(h.Node.prototype.getRootNode), se = b(fe), de = fe ? function(n) {
    ...
    , me = function(n) {
        ...
        var e, t, r = rn(n) ? n.dom().parentNode : n.dom();
        return r !== undefined && null !== r && null !== r.ownerDocument && me(Sn.fromDom(r)).fold(function() {
        ...
        if (!m(t))
            throw h.console.error("Invalid call to CSS.set. Property ", e, ":: Value ", t, ":: Element ", n),
        ...
        var t = n.dom()
          , r = h.window.getComputedStyle(t).getPropertyValue(e);
    ...
    var Ue = function(n, e, t) {
        for (var r = n.dom(), o = T(t) ? t : b(!1); r.parentNode; ) {
            r = r.parentNode;
            var u = Sn.fromDom(r);
            if (e(u))
                return S.some(u);
      ...
      , Ge = function(n, e, t) {
        return Ve(function(n, e) {
            return Jn(n, e)
        }, Ke, n, e, t)
    }
      , Ye = function(n, e, t) {
        return void 0 === t && (t = 0),
        sn(n, e).map(function(n) {
      ...
      , Qe = function(n) {
        return 1 < Je(n, "colspan")
    }
      , Ze = function(n) {
        return 1 < Je(n, "rowspan")
    }
      , nt = function(n, e) {
      ...
      , lt = function(n) {
        ...
        return k(e, function(n) {
            var e = n
              , t = oe(e).map(function(n) {
                var e = Q(n);
                return "tfoot" === e || "thead" === e || "tbody" === e ? e : "tbody"
            }).getOr("tbody")
              , r = k(it(n), function(n) {
                var e = Ye(n, "rowspan", 1)
                  , t = Ye(n, "colspan", 1);
                return _e(n, e, t)
            });
            return We(e, r, t)
      ...
      , dt = function(n) {
        var d = {}
          ...
          , t = n.length
          , m = 0;
        return E(n, function(n, f) {
            var s = [];
            E(n.cells(), function(n) {
                for (var e = 0; d[ft(f, e)] !== undefined; )
                    e++;
                for (var t, r, o, u = (t = n.element(),
                r = n.rowspan(),
                o = n.colspan(),
                {
                    element: b(t),
      ...
      , gt = function(n, e) {
        var t, u, r, i, c, a, l, o, f, s, d = function(n) {
            return Jn(n.element(), e)
        }, m = lt(n), g = mt.generate(m), p = (u = d,
        r = (t = g).grid.columns(),
        i = t.grid.rows(),
        c = r,
        l = a = 0,
        ...
        }),
        {
            ...
            maxRow: a,
            maxCol: l
        }), h = "th:not(" + e + "),td:not(" + e + ")", v = ot(n, "th,td", function(n) {
            return Jn(n, h)
        });
        return E(v, Me),
        function(n, e, t, r) {
            for (var o, u, i, c = e.grid.columns(), a = e.grid.rows(), l = 0; l < a; l++)
                for (var f = !1, s = 0; s < c; s++) {
                    if (!(l < t.minRow || l > t.maxRow || s < t.minCol || s > t.maxCol))
                        mt.getAt(e, l, s).filter(r).isNone() ? (o = f,
                        0,
                        u = n[l].element(),
                        i = Sn.fromTag("td"),
                        Be(i, Sn.fromTag("br")),
        ...
        E(s, Me),
        f.minCol !== f.maxCol && f.minRow !== f.maxRow || E(rt(o, "th,td"), function(n) {
            mn(n, "rowspan"),
            mn(n, "colspan")
        }),
        mn(o, "width"),
    ...
    var pt = function zs(t, r) {
      ...
      , wt = function(n) {
        return "img" === Q(n) ? 1 : vt(n).fold(function() {
            return ae(n).length
        }, function(n) {
            return n.length
        })
      ...
      , St = function(n) {
        ...
        (u = function(n) {
            for (var e = 0; e < n.childNodes.length; e++) {
                var t = Sn.fromDom(n.childNodes[e]);
                if (o(t))
                    return S.some(t);
      ...
      , Tt = function(n, u) {
        var i = function(n) {
            for (var e = ae(n), t = e.length - 1; 0 <= t; t--) {
                var r = e[t];
                if (u(r))
                    return S.some(r);
                var o = i(r);
      ...
      , Bt = function() {
        var n = Sn.fromTag("td");
        return Be(n, Sn.fromTag("br")),
        n
    }
      , It = function(n, e, t) {
        var r = At(n, e);
        return K(t, function(n, e) {
            null === n ? mn(r, e) : an(r, e, n)
        }),
        r
    }
      , Pt = function(n) {
      ...
      , Et = function(d, n, m) {
        return {
            row: kt(n),
            cell: function(n) {
                var r, o, u, e, t, i, c, a = re(n.element()), l = Sn.fromTag(Q(n.element()), a.dom()), f = m.getOr(["strong", "em", "b", "i", "span", "font", "h1", "h2", "h3", "h4", "h5", "h6", "p", "div"]), s = 0 < f.length ? (r = n.element(),
                o = l,
                u = f,
                St(r).map(function(n) {
                    var e = u.join(",")
                    ...
                    return N(t, function(n, e) {
                        var t = Ot(e);
                        return mn(t, "contenteditable"),
                        Be(n, t),
                        t
                    }, o)
                }).getOr(o)) : l;
                return Be(s, Sn.fromTag("br")),
                e = n.element(),
                t = l,
                i = e.dom(),
                c = t.dom(),
                ...
                Re(l, "height"),
                1 !== n.colspan() && Re(n.element(), "width"),
                d(n.element(), l),
                l
            },
            replace: It,
      ...
      , Wt = function(n, e) {
        return t = Math.min(n.row(), e.row()),
        r = Math.min(n.column(), e.column()),
        o = Math.max(n.row() + n.rowspan() - 1, e.row() + e.rowspan() - 1),
        u = Math.max(n.column() + n.colspan() - 1, e.column() + e.colspan() - 1),
        {
            startRow: b(t),
            startCol: b(r),
            finishRow: b(o),
      ...
      , jt = function(n, e, t) {
        var r = mt.findItem(n, e, Zn)
          , o = mt.findItem(n, t, Zn);
      ...
      , zt = function(e, n, t) {
        return jt(e, n, t).bind(function(n) {
            return function(n, e) {
                for (var t = !0, r = y(_t, e), o = e.startRow(); o <= e.finishRow(); o++)
      ...
      , Lt = function(n, e) {
        return mt.findItem(n, e, function(n, e) {
            return ee(e, n)
        }).map(function(n) {
            return n.element()
        })
      ...
      , qt = function(n, e, t, r, o) {
        var u = Vt(n)
          , i = Zn(n, t) ? S.some(e) : Lt(u, e)
          , c = Zn(n, o) ? S.some(r) : Lt(u, r);
      ...
      , Vt = mt.fromTable
      , Ut = ["body", "p", "div", "article", "aside", "figcaption", "figure", "footer", "header", "nav", "section", "ol", "ul", "li", "table", "thead", "tbody", "tfoot", "caption", "tr", "td", "th", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "pre", "address"];
    function Kt() {
        return {
            up: b({
                selector: Ke,
    ...
    var $t = function(r, o, n, e) {
      ...
      , Gt = function(n, e, t) {
        return 0 < t.length ? $t(n, e, (r = t)[0], r.slice(1)) : S.none();
        var r
    }
      , Yt = function(t, n, e, r) {
        void 0 === r && (r = f);
      ...
      , nr = function(l, f, s) {
        ...
        return Zn(l, f) ? S.some({
            ...
            return Zt(f).bind(function(u) {
                ...
                if (ee(a, u)) {
                    var n = 0 < (e = Le(f, "td,th", d(a))).length ? e[e.length - 1] : f;
                    return S.some({
                        boxes: qt(a, l, a, f, u),
                        start: l,
                        finish: n
                ...
                if (ee(u, a)) {
                    var e, t = 0 < (e = Le(l, "td,th", d(u))).length ? e[e.length - 1] : l;
                    return S.some({
                        boxes: qt(u, l, a, f, u),
                        start: l,
                        finish: t
                ...
                return Yt(Jt, l, f, r).shared().bind(function(n) {
                    return Ge(n, "table", s).bind(function(n) {
                        var e = Le(f, "td,th", d(n))
      ...
      , er = function(n, e) {
        var t = qe(n, e);
        return 0 < t.length ? S.some(t) : S.none()
    }
      , tr = function(n, e, r) {
      ...
      , or = function(r, n, e) {
        return tr(r, n, e).bind(function(i) {
            var n = function(n) {
              ...
              , e = Ke(i.first(), "thead,tfoot,tbody,table", n)
              , t = Ke(i.last(), "thead,tfoot,tbody,table", n);
            return e.bind(function(u) {
                return t.bind(function(n) {
                    return Zn(u, n) ? (e = i.table(),
                    t = i.first(),
                    r = i.last(),
                    o = Vt(e),
                    zt(o, t, r)) : S.none();
      ...
      , ur = "data-mce-selected"
      , ir = "data-mce-first-selected"
      , cr = "data-mce-last-selected"
      , ar = ur
      , lr = "td[data-mce-selected],th[data-mce-selected]"
      , fr = "[data-mce-selected]"
      , sr = ir
      , dr = "td[data-mce-first-selected],th[data-mce-first-selected]"
      , mr = cr
      , gr = "td[data-mce-last-selected],th[data-mce-last-selected]"
      , pr = /* */
    Object.freeze({
        __proto__: null,
        selected: ar,
      ...
      , Tr = function(n, e, t) {
        return {
            element: b(t),
            mergable: b((o = e,
            br(n.get(), S.none, function(e, n) {
                return 0 === e.length ? S.none() : or(o, dr, gr).bind(function(n) {
                    return 1 < e.length ? S.some({
                        bounds: b(n),
                        cells: b(e)
                    }) : S.none()
                })
            }, S.none))),
            unmergable: b(0 < (r = Sr(t, n)).length && L(r, function(n) {
                return dn(n, "rowspan") && 1 < parseInt(fn(n, "rowspan"), 10) || dn(n, "colspan") && 1 < parseInt(fn(n, "colspan"), 10)
            }) ? S.some(r) : S.none()),
            selection: b(Sr(t, n))
        };
        var r, o
      ...
      , Rr = function(m, n, g, p) {
        m.on("BeforeGetContent", function(t) {
            !0 === t.selection && br(n.get(), w, function(n) {
                t.preventDefault(),
                ct(n[0]).map(Dt).map(function(n) {
                    return [gt(n, fr)]
                }).each(function(n) {
                    var e;
                    t.content = "text" === t.format ? k(n, function(n) {
        ...
        m.on("BeforeSetContent", function(d) {
            !0 === d.selection && !0 === d.paste && S.from(m.dom.getParent(m.selection.getStart(), "th,td")).each(function(n) {
                var s = Sn.fromDom(n);
                ct(s).each(function(e) {
                    var n, t, r, o, u, i, c = M((n = d.content,
                    (r = (t || h.document).createElement("div")).innerHTML = n,
                    ae(Sn.fromDom(r))), function(n) {
                        return "meta" !== Q(n)
                    });
                    if (1 === c.length && (i = c[0],
                    "table" === Q(i))) {
                        d.preventDefault();
                        var a = Sn.fromDom(m.getDoc())
                          , l = Mt(a)
                          , f = (o = s,
                        u = c[0],
                        {
      ...
      , Br = function(n) {
        var e = n.dom().ownerDocument
          ...
          , o = e.documentElement;
        if (t === n.dom())
            return Dr(t.offsetLeft, t.offsetTop);
        var u = Ar(r.pageYOffset, o.scrollTop)
          , i = Ar(r.pageXOffset, o.scrollLeft)
          , c = Ar(o.clientTop, t.clientTop)
          , a = Ar(o.clientLeft, t.clientLeft);
        return Ir(n).translate(i - a, u - c)
    }
      , Ir = function(n) {
        var e, t = n.dom(), r = t.ownerDocument.body;
        return r === t ? Dr(r.offsetLeft, r.offsetTop) : ve(n) ? (e = t.getBoundingClientRect(),
        Dr(e.left, e.top)) : Dr(0, 0)
    }
      , Pr = function(n) {
        var e = S.from(n.dom().documentElement).map(Sn.fromDom).getOr(n);
        return {
            parent: b(e),
            view: b(n),
            origin: b(Dr(0, 0))
    ...
    var Mr = Er("height", function(n) {
      ...
      , Gr = function(t, e, r) {
        if (0 === r.length)
            return [];
        var n = k(r.slice(1), function(n, e) {
        ...
        return k(e, function(e) {
            return no(function() {
                return F(r, function(n) {
                    return mt.getAt(t, n, e).filter(function(n) {
                        return n.column() === e
                    }).fold(b([]), function(n) {
                        return [n]
                    })
      ...
      , eo = function(t) {
        ...
        return k(e, function(e) {
            return no(function() {
                return F(r, function(n) {
                    return mt.getAt(t, e, n).filter(function(n) {
                        return n.row() === e
                    }).fold(b([]), function(n) {
                        return [n]
                    })
      ...
      , to = function(r, o) {
        ...
        var n = r[o].fold(function() {
            var n, e, t = (n = r.slice(0, o),
            (e = O.call(n, 0)).reverse(),
            e);
      ...
      , uo = function(n) {
        return ro() ? (t = (e = n).dom().getBoundingClientRect().height,
        "border-box" === Se(e, "box-sizing") ? t : t - oo(e, "padding-top", 0) - oo(e, "padding-bottom", 0) - (oo(e, "border-top-width", 0) + oo(e, "border-bottom-width", 0))) : oo(n, "height", Nr(n));
        var e, t
    }
      , io = function(n) {
        return ro() ? (t = (e = n).dom().getBoundingClientRect().width,
        "border-box" === Se(e, "box-sizing") ? t : t - oo(e, "padding-left", 0) - oo(e, "padding-right", 0) - (oo(e, "border-left-width", 0) + oo(e, "border-right-width", 0))) : oo(n, "width", jr(n));
        var e, t
    }
      , co = /(\d+(\.\d+)?)(\w|%)*/
      , ao = /(\d+(\.\d+)?)%/
      ...
      , fo = function(n, e) {
        var t, r = (t = n,
        S.from(t.dom().offsetParent).map(Sn.fromDom).getOr(be(re(n))));
        return e(n) / e(r) * 100
    }
      , so = function(n, e) {
        ye(n, "width", e + "px")
      ...
      , po = function(n, e, t, r) {
        ...
        return vn(n, "%") && "table" !== Q(e) ? (u = l,
        i = t,
        c = r,
        a = ct(o = e).map(function(n) {
            var e = i(n);
      ...
      , ho = function(n) {
        var e, t = Te(e = n, "height").getOrThunk(function() {
            return uo(e) + "px"
        });
        return t ? po(t, n, Nr, go) : Nr(n)
    }
      , vo = function(n) {
        return Te(n, "width").fold(function() {
      ...
      , Bo = function(n, e, t, r, o) {
        var u = Zr(n)
          , i = k(u, function(n) {
            return n.map(e.edge)
        });
        return k(u, function(n, e) {
            return n.filter(d(Qe)).fold(function() {
                var n = to(i, e);
                return r(n)
            }, function(n) {
                return t(n, o)
      ...
      , Eo = function(n, e, t, r) {
        ...
        return k(o, function(n, e) {
            return n.filter(d(Ze)).fold(function() {
                var n = to(u, e);
                return r(n)
            }, function(n) {
                return t(n)
      ...
      , _o = xn(xn({}, Mo), {
        from: function(n) {
            return vn(n, "%") ? No("%", Mo.percent, n) : vn(n, "px") ? No("px", Mo.pixels, n) : Mo.invalid(n)
        }
    })
      , Wo = function(n, r, o) {
        return n.fold(function() {
            ...
            return t = (e = n) / o,
            k(r, function(n) {
                return _o.from(n).fold(function() {
                    return n
                }, function(n) {
                    return n * t + "px"
                }, function(n) {
      ...
      , jo = function(n, e, t) {
        var r, o, u, i = _o.from(t), c = L(n, function(n) {
            return "0px" === n
        }) ? (r = i,
        o = n.length,
        u = r.fold(function() {
      ...
      , zo = function(n, e) {
        return 0 === n.length ? e : N(n, function(n, e) {
      ...
      , Fo = function(n) {
        if (0 === n.length)
            return n;
        var e, t, r = N(n, function(n, e) {
            var t = _o.from(e).fold(function() {
                return {
                    value: e,
                    remainder: 0
                }
        ...
        return o.slice(0, o.length - 1).concat([(e = o[o.length - 1],
        t = Math.round(r.remainder),
        _o.from(e).fold(b(e), function(n) {
            return n + t + "px"
        }, function(n) {
            return n + t + "%"
        }))])
      ...
      , qo = function(a, n, e, c, l) {
        var f = mt.fromTable(a)
          , s = f.all
          , d = mt.justCells(f);
        n.each(function(n) {
            var r, o, e = Ho(n), t = jr(a), u = Bo(f, c, Do, Io, l), i = jo(u, t, n);
            r = i,
            o = e,
            E(d, function(n) {
        ...
        e.each(function(n) {
            var r, e, o, t = Ho(n), u = Nr(a), i = Eo(f, Yr, Ao, Io), c = jo(i, u, n);
            r = c,
            e = s,
            o = t,
            E(d, function(n) {
        ...
        var r = function() {
            ...
            return function() {
                ...
                if (e.length !== t.length)
                    throw new Error('Wrong number of arguments to struct. Expected "[' + e.length + ']", got ' + t.length + " arguments");
                var r = {};
      ...
      , Zo = xn({}, Qo)
      , nu = function(n, e, u, i) {
        var t, r, c = n.slice(0), o = (r = e,
        0 === (t = n).length ? Zo.none() : 1 === t.length ? Zo.only(0) : 0 === r ? Zo.left(0, 1) : r === t.length - 1 ? Zo.right(r - 1, r) : 0 < r && r < t.length - 1 ? Zo.middle(r - 1, r, r + 1) : Zo.none()), a = function(n) {
            return k(n, b(0))
        }, l = b(a(c)), f = function(n, e) {
            if (0 <= u) {
                var t = Math.max(i.minCellWidth(), c[e] - u);
                return a(c.slice(0, n)).concat([u, t - c[e]]).concat(a(c.slice(e + 1)))
            }
            var r = Math.max(i.minCellWidth(), c[n] + u)
              , o = c[n] - r;
            return a(c.slice(0, n)).concat([r - c[n], o]).concat(a(c.slice(e + 1)))
        }, s = f;
        return o.fold(l, function(n) {
            return i.singleColumnWidth(c[n], u)
        }, s, function(n, e, t) {
            return f(e, t)
        }, function(n, e) {
            if (0 <= u)
                return a(c.slice(0, e)).concat([u]);
            var t = Math.max(i.minCellWidth(), c[e] + u);
      ...
      , tu = function(n, t) {
        var e = mt.justCells(n);
        return k(e, function(n) {
            var e = eu(n.column(), n.column() + n.colspan(), t);
            return {
                element: n.element(),
                width: e,
                colspan: n.colspan()
      ...
      , ru = function(n, t, r, e) {
        var o, u, i, c, a = mt.fromTable(n), l = Eo(a, e, Co, function(n) {
        ...
        i = mt.justCells(o),
        k(i, function(n) {
            var e = eu(n.row(), n.row() + n.rowspan(), u);
            return {
                element: n.element,
                height: b(e),
                rowspan: n.rowspan
        ...
        var m = N(f, function(n, e) {
            return n + e
        }, 0);
        go(n, m)
    }
      , ou = function(n) {
        var t, r, e, o, u, i = Sn.fromDom(pe(n).getOr(n.target)), c = function() {
      ...
      , mu = function(n, e) {
        return o = e,
        0 < (u = M(fu(t = n, r = "class"), function(n) {
            return n !== o
        })).length ? an(t, r, u.join(" ")) : mn(t, r),
        !1;
        var t, r, o, u
    }
      , gu = function(n, e) {
      ...
      , pu = function(n) {
        0 === (su(n) ? n.dom().classList : fu(n, "class")).length && mn(n, "class")
    }
      , hu = function(n, e) {
      ...
      , yu = function(r, o, u) {
        ...
        return function(e, n) {
            ...
            E(n, function(n) {
                if (!m(n))
                    throw new Error("The value " + n + " in the " + e + " fields was not a string.")
            })
        }("required", o),
        t = wu(o),
        W(t, function(n, e) {
        ...
        function(e) {
            ...
            L(o, function(n) {
                ...
                throw new Error("All required keys (" + wu(n).join(", ") + ") were not specified. Specified keys were: " + wu(e).join(", ") + ".")
            }(o, t),
            r(o, t);
            var n = M(o, function(n) {
                return !u.validate(e[n], n)
            });
            return 0 < n.length && function(n, e) {
                throw new Error("All values need to be of type: " + e + ". Keys (" + wu(n).join(", ") + ") were not.")
            }(n, u.label),
            e
        }
    }
      , Cu = function(e, n) {
        var t = M(n, function(n) {
            return !B(e, n)
        });
      ...
      , xu = Su(["compare", "extract", "mutate", "sink"])
      , Tu = Su(["element", "start", "stop", "destroy"])
      , Ru = Su(["forceDrop", "drop", "move", "delayDrop"])
      , Ou = xu({
        ...
        sink: function(n, e) {
            var t = function(n) {
              ...
              , r = au(t.element(), "mousedown", n.forceDrop)
              , o = au(t.element(), "mouseup", n.drop)
              , u = au(t.element(), "mousemove", n.move)
              , i = au(t.element(), "mouseout", n.delayDrop);
            return Tu({
                element: t.element,
                start: function(n) {
                    Be(n, t.element())
    ...
    var Bu = function(e, t, n) {
      ...
      , Iu = function(n) {
        return "true" === fn(n, "contenteditable")
    }
      , Pu = vu("ephox-snooker").resolve
      , ku = function() {
        var t, r = Jo({
            drag: Yo(["xDelta", "yDelta", "target"])
        }), o = S.none(), n = {
            mutate: function(n, e) {
                t.trigger.drag(n, e)
            },
            events: (t = Jo({
                drag: Yo(["xDelta", "yDelta"])
            })).registry
        };
      ...
      , Fu = function(n, e, t, r) {
        _u(n);
        var o = mt.fromTable(e);
        !function(n, e, t, r, o, u) {
            var i = Br(e)
              , c = 0 < t.length ? o.positions(t, e) : [];
            zu(n, c, i, zr(e));
            var a = 0 < r.length ? u.positions(r, e) : [];
            ju(n, a, i, _r(e))
        }(n, e, eo(o), Zr(o), t, r)
    }
      , Lu = function(n, e) {
        var t = qe(n.parent(), "." + Eu);
        E(t, e)
    }
      , Hu = function(n) {
        Lu(n, function(n) {
      ...
      , Vu = Pu("resizer-bar-dragging")
      , Uu = function(o, e, u) {
        var t = ku()
          , r = function(n, e) {
            void 0 === e && (e = {});
            var t = e.mode !== undefined ? e.mode : Ou;
            return Bu(n, t, e)
        }(t, {})
          , i = S.none()
          , n = function(n, e) {
        ...
        var a = function(n, e) {
          ...
          , l = au(o.parent(), "mousedown", function(n) {
            var e, t;
            e = n.target(),
          ...
          , d = au(o.view(), "mouseover", function(n) {
            s(n.target()).fold(function() {
                ve(n.target()) && _u(o)
            }, function(n) {
                i = S.some(n),
                Fu(o, n, u, e)
      ...
      , Ku = function(n, p, h) {
        ...
        e.events.adjustWidth.bind(function(n) {
            var e = n.table();
            v.trigger.beforeResize(e);
            var t, r, o, u, i, c, a, l, f, s, d, m = p.delta(n.delta(), e), g = h(e);
            t = e,
            r = m,
            o = n.column(),
            u = p,
      ...
      , ai = function(n) {
        return "relative" === Zu(n) || !0 === ni(n)
    }
      , li = function(n) {
        return "fixed" === Zu(n) || !1 === ni(n)
    }
      , fi = function(n) {
        return "responsive" === Zu(n)
    }
      , si = function(n) {
        var e = "section"
      ...
      , di = function(n) {
        ...
        return m(e) ? S.some(e.split(/[ ,]/)) : Array.isArray(e) ? S.some(e) : S.none()
    }
      , mi = function(n) {
      ...
      , Ti = function(n) {
        return "rtl" == ("rtl" === Se(n, "direction") ? "rtl" : "ltr") ? xi : Si
    }
      , Ri = function(n) {
        var e = n;
        return {
      ...
      , ki = function(n, e) {
        if (ai(n)) {
            var t = yi(n, e.dom()).filter(Ci).getOrThunk(function() {
                return $o(e)
            });
            return Pi(t, e)
        }
      ...
      , Mi = function(n, e, t) {
        var r = jr(n) + "px";
        qo(n, S.some(r), S.none(), e, t),
        Ei(n)
    }
      , Ni = function(n, e) {
        var t, r, o, u, i = Go(Ti), c = ki(n, e);
        r = i,
        o = c,
        u = xo(t = e),
      ...
      , zi = function(c) {
        var u, i, a = S.none(), l = S.none(), f = S.none(), s = function(n) {
            return "TABLE" === n.nodeName
        }, n = function() {
            return l
        };
        return c.on("init", function() {
            var n, e, t = Go(Ti), r = (n = c).inline ? kr(gi(n), ji()) : Pr(Sn.fromDom(n.getDoc()));
            if (f = S.some(r),
            e = c.getParam("object_resizing", !0),
            (m(e) ? "table" === e : e) && c.getParam("table_resize_bars", !0, "boolean")) {
                var o = Ku(r, t, function(n) {
                    return ki(c, n)
                });
                o.on(),
      ...
      , qi = function(n, e) {
        var t = Li(n, e, n.query().prevSibling).getOr(e);
        if (n.property().isText(t))
            return Fi(t, Hi(n, t));
        var r = n.property().children(t);
        return 0 < r.length ? qi(n, r[r.length - 1]) : Fi(t, Hi(n, t))
    }
      , Vi = qi
      , Ui = Kt()
      , Ki = function(t, r) {
        vo(t).bind(function(n) {
            var e = co.exec(n);
            return null !== e ? S.some({
                width: b(parseFloat(e[1])),
                unit: b(e[3])
            }) : S.none()
        }).each(function(n) {
            var e = n.width() / 2;
      ...
      , Yi = function(o, n) {
        var u = []
          , i = []
          , c = H(He(o, "caption,colgroup")).fold(function() {
            return y(Ae, o)
        }, function(n) {
            return y(De, n)
        })
          , e = function(n, e) {
            0 < n.length ? function(n, e) {
                var t = $e(o, e).getOrThunk(function() {
                    var n = Sn.fromTag(e, re(o).dom());
                    return "thead" === e ? c(n) : Be(o, n),
                    n
                });
                Ee(t);
                var r = k(n, function(n) {
      ...
      , oc = function(n, e, t, r) {
        var o, u = n[e].cells().slice(t), i = rc(u, r), c = (o = t,
        k(n, function(n) {
            return nc(n, o)
        }).slice(e));
        return {
      ...
      , uc = function(a, l) {
        var f = k(a, function(n) {
            return k(n.cells(), function() {
                return !1
            })
        });
        return k(a, function(n, c) {
            var e, t, r = F(n.cells(), function(n, e) {
                if (!1 !== f[c][e])
                    return [];
                var t, r, o, u, i = oc(a, c, e, l);
      ...
      , ic = function(n, e, t) {
        for (var r = [], o = 0; o < n.grid.rows(); o++) {
            for (var u = [], i = 0; i < n.grid.columns(); i++) {
                var c = mt.getAt(n, o, i).map(function(n) {
      ...
      , fc = function(l, e, f, s, d) {
        return function(r, o, n, u, i, c) {
            var a = mt.fromTable(o);
            return e(a, n).map(function(n) {
                var e = ic(a, u, !1)
                  , t = l(e, n, Zn, d(u))
                  , r = ac(t.grid(), u);
                return {
                ...
                var e = Yi(o, n.grid())
                  , t = S.from(c).getOrThunk(function() {
                    return Bi(o)
                });
                return f(o, n.grid(), i, t),
                s(o),
                Fu(r, o, Yr, i),
                S.some({
                    cursor: n.cursor,
      ...
      , dc = function(e, n) {
        var t = k(n.selection(), function(n) {
            return ut(n).bind(function(n) {
                return lc(e, n)
            })
        })
          , r = Xi(t);
        return 0 < r.length ? S.some({
            cells: r,
      ...
      , gc = function(n, e, t, r) {
        for (var o = !0, u = 0; u < n.length; u++)
            for (var i = 0; i < tc(n[0]); i++) {
                var c = t(ec(n[u], i), e);
                !0 === c && !1 === o ? Ji(n[u], i, je(r(), !0)) : !0 === c && (o = !1)
            }
        return n
    }
      , pc = function(u, t, i, c) {
        if (0 < t && t < u.length) {
            ...
            E(e, function(r) {
                for (var o = S.none(), n = function(t) {
                    for (var n = function(e) {
                        var n = u[t].cells()[e];
                        i(n.element(), r.element()) && (o.isNone() && (o = S.some(c())),
                        o.each(function(n) {
                            Ji(u[t], e, je(n, !0))
                        }))
                    }, e = 0; e < tc(u[0]); e++)
      ...
      , Tc = function(n, e, t) {
        var r = e.colDelta < 0 ? xc : u;
        return (e.rowDelta < 0 ? Sc : u)(r(n, Math.abs(e.colDelta), t), Math.abs(e.rowDelta), t)
    }
      , Rc = function(t, r, o, u, i) {
        return function(n, e, t) {
            if (n.row() >= e.length || n.column() > tc(e[0]))
                return bc.error("invalid start address out of table bounds, row: " + n.row() + ", column: " + n.column());
            var r = e.slice(n.row())
            ...
            return function(n, e, t, r, o) {
                for (var u, i, c, a, l, f = n.row(), s = n.column(), d = f + t.length, m = s + tc(t[0]), g = f; g < d; g++)
                    for (var p = s; p < m; p++) {
                        c = p,
                        l = a = void 0,
                        a = y(o, nc((u = e)[i = g], c).element()),
                        l = u[i],
                        1 < u.length && 1 < tc(l) && (0 < c && a(ec(l, c - 1)) || c < l.cells().length - 1 && a(ec(l, c + 1)) || 0 < i && a(ec(u[i - 1], c)) || i < u.length - 1 && a(ec(u[i + 1], c))) && gc(e, ec(e[g], p), o, r.cell);
                        var h = ec(t[g - f], p - s)
                          , v = r.replace(h);
                        Ji(e[g], p, je(v, !0))
                    }
      ...
      , Oc = function(r, n, e, t, o) {
        var u, i, c, a;
        u = n,
        i = r,
        c = o,
        a = t.cell,
        0 < i && i < u[0].cells().length && E(u, function(n) {
            var e = n.cells()[i - 1]
              , t = n.cells()[i];
        ...
        return k(d, function(n, e) {
            var t = n.cells().slice(0, r).concat(f[e].cells()).concat(n.cells().slice(r, n.cells().length));
            return Qi(n, t)
        })
    }
      , Dc = function(n, e, t, r, o) {
        pc(e, n, o, r.cell);
        var u = wc(t, e)
          , i = Tc(t, u, r)
          , c = wc(e, i)
      ...
      , Ac = function(t, r, n, o, u) {
        var e = t.slice(0, r)
          , i = t.slice(r)
          , c = Zi(t[n], function(n, e) {
            return 0 < r && r < t.length && o(ec(t[r - 1], e), ec(t[r], e)) ? nc(t[r], e) : je(u(n.element(), o), !0)
        });
        return e.concat([c]).concat(i)
    }
      , Bc = function(n, l, f, s, d) {
        return k(n, function(n) {
            var e, t, r, o, u, i, c, a = 0 < l && l < tc(n) && s(ec(n, l - 1), ec(n, l)) ? nc(n, l) : je(d(ec(n, f), s), !0);
            return t = l,
            r = a,
            o = (e = n).cells(),
            u = o.slice(0, t),
      ...
      , Ic = function(n, t, r, o) {
        return k(n, function(n) {
            return Zi(n, function(n) {
                ...
                }) ? je(o(n.element(), r), !0) : n;
                var e
            })
        })
    }
      , Pc = function(n, e, t, r) {
        return ec(n[e], t) !== undefined && 0 < e && r(ec(n[e - 1], t), ec(n[e], t))
    }
      , kc = function(n, e, t) {
        return 0 < e && t(ec(n, e - 1), ec(n, e))
    }
      , Ec = function(t, r, o, n) {
        var e = F(t, function(n, e) {
      ...
      , Mc = function(t, r, o, n) {
        var u = t[r]
          , e = F(u.cells(), function(n, e) {
            return Pc(t, r, e, o) || kc(u, e, o) ? [] : [n]
        });
        return Ic(t, e, o, n)
    }
      , Nc = Su(["cell", "row", "replace", "gap"])
      , _c = function(n) {
        var e = Ye(n, "colspan", 1)
          , t = Ye(n, "rowspan", 1);
        return {
            element: b(n),
            colspan: b(e),
      ...
      , Wc = function(r, o) {
        ...
        var t = Ri(S.none())
          ...
          , i = function(n) {
            var e = u(n);
            return t.get().isNone() && t.set(S.some(e)),
            c = S.some({
                item: n,
                replacement: e
            }),
      ...
      , zc = function(t) {
        ...
        return {
            combine: function(e) {
                return n.get().isNone() && n.set(S.some(e)),
                function() {
                    var n = t.cell({
                        element: b(e),
                        colspan: b(1),
      ...
      , Fc = ["body", "p", "div", "article", "aside", "figcaption", "figure", "footer", "header", "nav", "section", "ol", "ul", "table", "thead", "tfoot", "tbody", "caption", "tr", "td", "th", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "pre", "address"]
      , Lc = Kt()
      , Hc = function(n) {
        return e = n,
        t = Lc.property().name(e),
        B(Fc, t);
        var e, t
    }
      , qc = function(n) {
      ...
      , Vc = function(n) {
        return e = n,
        B(["br", "img", "hr", "input"], Lc.property().name(e));
        var e
    }
      , Uc = function(n) {
        var e, u = function(n) {
            ...
            return xt(o).bind(function(t) {
                var r = ce(t).map(function(n) {
                    return !!Hc(n) || !!Vc(n) && "img" !== Q(n)
                }).getOr(!1);
                return oe(t).map(function(n) {
                    return !0 === r || ("li" === Q(e = n) || Ue(e, qc).isSome()) || u(t) || Hc(n) && !Zn(o, n) ? [] : [Sn.fromTag("br")];
                    var e
                })
            }).getOr([])
        }, r = 0 === (e = F(n, function(n) {
            var e = ae(n);
            return L(e, function(n) {
                return u(n) || rn(n) && 0 === ht(n).trim().length
            }) ? [] : e.concat(t(n))
        })).length ? [Sn.fromTag("br")] : e;
        Ee(n[0]),
        ke(n[0], r)
    }
      , Kc = function(n) {
      ...
      , na = function(n, e) {
        var t = M(n, e);
        return 0 === t.length ? S.some("td") : t.length === n.length ? S.some("th") : S.none()
    }
      , ea = function(n, e, t, r) {
        var o = mt.generate(e)
          , u = r.getWidths(o, t, r)
      ...
      , ia = fc(function(n, e, t, r) {
        var o, u, i, c, a = Qc(e), l = (o = n,
        u = a[0].column(),
        ...
        })), f = Xc(l, e[0].row(), e[0].column());
        return $c(l, f)
    }, mc, ea, Kc, Wc)
      , ca = fc(function(n, e, t, r) {
        var o, u, i, c = Jc(e), a = (o = n,
        u = c[0].row(),
        i = c[c.length - 1].row(),
        o.slice(0, u).concat(o.slice(i + 1))), l = Xc(a, e[0].row(), e[0].column());
        return $c(a, l)
    }, mc, w, Kc, Wc)
      , aa = fc(function(n, e, t, r) {
        var o = Ec(n, e.column(), t, r.replaceOrInit);
        return Yc(o, e.row(), e.column())
    }, sc, w, w, jc("row", "th"))
      , la = fc(function(n, e, t, r) {
        var o = Ec(n, e.column(), t, r.replaceOrInit);
        return Yc(o, e.row(), e.column())
    }, sc, w, w, jc(null, "td"))
      , fa = (fc(function(n, e, t, r) {
        var o = Mc(n, e.row(), t, r.replaceOrInit);
        return Yc(o, e.row(), e.column())
    }, sc, w, w, jc("col", "th")),
    fc(function(n, e, t, r) {
        var o = Mc(n, e.row(), t, r.replaceOrInit);
    ...
    fc(function(n, e, t, r) {
        ...
        var u = function(n, e, t) {
            if (0 === n.length)
                return n;
            for (var r = e.startRow(); r <= e.finishRow(); r++)
                for (var o = e.startCol(); o <= e.finishCol(); o++)
                    Ji(n[r], o, je(t(), !1));
            return n
        }(n, e.bounds(), b(o[0]));
      ...
      , sa = fc(function(n, e, t, r) {
        var o = N(e, function(n, e) {
      ...
      , da = fc(function(n, t, e, r) {
        var o, u, i, c, a, l = (o = t.clipboard(),
        u = t.generators(),
        i = mt.fromTable(o),
        ic(i, u, !0)), f = (c = t.row(),
        a = t.column(),
        ...
        return Rc(f, n, l, t.generators(), e).fold(function() {
            return $c(n, S.some(t.element()))
        }, function(n) {
            var e = Xc(n, t.row(), t.column());
            return $c(n, e)
        })
    }, function(e, t) {
      ...
      , ma = fc(function(n, e, t, r) {
        var o = n[e.cells[0].row()]
          , u = e.cells[0].column()
          , i = Zc(e.clipboard(), e.generators(), o)
          , c = Oc(u, n, i, e.generators(), t)
          , a = Xc(c, e.cells[0].row(), e.cells[0].column());
        return $c(c, a)
    }, dc, w, w, Wc)
      , ga = fc(function(n, e, t, r) {
        var o = n[e.cells[0].row()]
      ...
      , pa = fc(function(n, e, t, r) {
        var o = n[e.cells[0].row()]
          , u = e.cells[0].row()
          , i = Zc(e.clipboard(), e.generators(), o)
          , c = Dc(u, n, i, e.generators(), t)
          , a = Xc(c, e.cells[0].row(), e.cells[0].column());
        return $c(c, a)
    }, dc, w, w, Wc)
      , ha = fc(function(n, e, t, r) {
        var o = n[e.cells[0].row()]
      ...
      , ya = function(n, e) {
        return "thead" === (t = wa(0, e).fold(function() {
            return ba(e)
        }, function(n) {
            return "thead"
      ...
      , Ca = function(e, n, t) {
        var r = e.getParent(n, "table")
          ...
          , u = mi(o);
        if (t !== u) {
            var i = e.select(t, r)[0];
            if (!i) {
                i = e.create(t);
                var c = r.firstChild;
                "thead" === t ? H(He(Sn.fromDom(r), "caption,colgroup")).fold(function() {
                    return r.insertBefore(i, c)
                }, function(n) {
                    return e.insertAfter(i, n.dom())
                }) : r.appendChild(i)
            }
            "tbody" === t && "thead" === u && i.firstChild ? i.insertBefore(n, i.firstChild) : i.appendChild(n),
            o.hasChildNodes() || e.remove(o)
        }
    }
      , Sa = function(t, n, r, o) {
        return E(n, function(n) {
            var e = mi(n) !== r ? t.rename(n, r) : n;
      ...
      , xa = function(n, e, t) {
        ...
        if ("header" === t) {
            var u = si(n)
              , i = "auto" === u ? (r = ct(Sn.fromDom(e.cells[0])).map(function(n) {
                return at(n)
            }).getOr([]),
            q(r, function(n) {
                return wa(0, n.dom())
            ...
            Sa(o, e.cells, "section" === i ? "td" : "th", "col"),
            Ca(o, e, "cells" === i ? "tbody" : "thead")
        } else
            Sa(o, e.cells, "td", null),
            Ca(o, e, "footer" === t ? "tfoot" : "tbody")
    }
      , Ta = function(e) {
        return {
            get: function() {
                var n = gi(e);
                return er(n, lr).fold(function() {
                    return e.selection.getStart() === undefined ? wr() : Cr(e.selection)
                }, function(n) {
                    return yr(n)
                })
            }
      ...
      , Ra = function(e) {
        return function(n) {
            return S.from(n.dom.getParent(n.selection.getStart(), e)).map(function(n) {
                return Sn.fromDom(n)
            })
        }
    }
      ...
      , Ba = function(t) {
        var n, e, r, o = Oa(t), u = o.bind(function(n) {
            return ct(n)
        }).map(function(n) {
            return at(n)
        }).map(function(n) {
        ...
        r = function(e, n) {
            return M(n, function(n) {
                return I(n.cells, function(n) {
                    return "1" === t.dom.getAttrib(n, ar) || n === e.dom()
                })
            })
        }
        ,
        ((n = o).isSome() && e.isSome() ? S.some(r(n.getOrDie(), e.getOrDie())) : S.none()).getOr([])
    }
      , Ia = function(s, n) {
        var e = function(n) {
            return "table" === Q(gi(n))
          ...
          , t = function(c, a, l, f) {
            return function(n, e) {
                wi(n);
                var t = f()
                  , r = Sn.fromDom(s.getDoc())
                  , o = Go(Ti)
                  , u = Et(l, r, d)
                  , i = ki(s, n);
                return a(n) ? c(t, n, e, u, o, i).bind(function(n) {
                    ...
                    n.cursor().map(function(n) {
                        var e = Vi(Ui, n)
                          , t = s.dom.createRng();
                        return t.setStart(e.element().dom(), e.offset()),
          ...
          , r = t(ca, function(n) {
            return !1 === e(s) || 1 < $i(n).rows()
        }, w, n)
          , o = t(ia, function(n) {
            return !1 === e(s) || 1 < $i(n).columns()
        }, w, n)
          , u = t(ta, C, w, n)
          , i = t(ra, C, w, n)
          , c = t(oa, C, Ki, n)
        ...
        return P(n, function(n) {
            return function(n, e, t, r) {
                for (var o = Sn.fromTag("tr"), u = 0; u < n; u++) {
                    var i = r < e || u < t ? Sn.fromTag("th") : Sn.fromTag("td");
                    u < t && an(i, "scope", "row"),
                    r < e && an(i, "scope", "col"),
                    Be(i, Sn.fromTag("br")),
                    Be(o, i)
      ...
      , Ea = function(n, e) {
        n.selection.select(e.dom(), !0),
        n.selection.collapse(!0)
    }
      , Ma = function(o, n, e, t, r) {
        var u = ti(o)
          , i = {
            styles: u,
            attributes: ei(o)
          ...
          , c = function(n, e, t, r, o, u) {
            void 0 === u && (u = Pa);
            var i = Sn.fromTag("table")
              , c = "cells" !== o;
            Ce(i, u.styles),
            ln(i, u.attributes);
            var a = Math.min(n, t);
            if (c && 0 < t) {
                var l = Sn.fromTag("thead");
                Be(i, l);
                var f = ka(t, e, "sectionCells" === o ? a : 0, r);
                ke(l, f)
            }
            var s = Sn.fromTag("tbody");
            Be(i, s);
            var d = ka(c ? n - a : n, e, c ? 0 : t, r);
            return ke(s, d),
            i
        }(e, n, r, t, si(o), i);
        ...
        Be(l, f),
        l.dom().innerHTML);
        return o.insertContent(s),
        Xe(gi(o), 'table[data-mce-id="__mce"]').map(function(n) {
            var e, t, r;
            return li(o) ? _i(o, n) : fi(o) ? Wi(n) : (ai(o) || (e = u.width,
            m(e) && -1 !== e.indexOf("%"))) && Ni(o, n),
            wi(n),
            mn(n, "data-mce-id"),
            t = o,
      ...
      , Wa = function(t) {
        return function(n) {
            var e = 0 < n.length ? S.some(k(n, Sn.fromDom)) : S.none();
            t(e)
        }
    }
      , ja = function(r, n, e, t) {
        return {
            insertTable: function(n, e, t) {
                return void 0 === t && (t = {}),
                Na(r, e, n, t, "Invalid values for insertTable - rows and columns values are required to insert a table.")
            },
      ...
      , za = function(n, e) {
        var t = mt.fromTable(n);
        return mc(t, e).map(function(n) {
            var e = n[n.length - 1]
              , i = n[0].column()
              , c = e.column() + e.colspan();
            return k(t.all, function(n) {
                var e = M(n.cells(), function(n) {
                    return n.column() >= i && n.column() < c
                })
                  , t = k(e, function(n) {
                    var e, t, r, o, u = Dt(n.element());
                    return r = c - i,
                    o = Je(e = u, t = "colspan"),
                    1 === r || o <= 1 ? mn(e, t) : an(e, t, Math.min(r, o)),
                    u
                })
                  , r = Sn.fromTag("tr");
                return ke(r, t),
      ...
      , Fa = function(n, e, r) {
        var o = mt.fromTable(n);
        return mc(o, e).map(function(n) {
            var e = ic(o, r, !1).slice(n[0].row(), n[n.length - 1].row() + n[n.length - 1].rowspan())
              , t = ac(e, r);
      ...
      , La = tinymce.util.Tools.resolve("tinymce.util.Tools")
      , Ha = function(o, n, u) {
        return function(n, e) {
      ...
      , Ua = function(n, e) {
        return (e || []).concat(k(n, function(n) {
            return {
                text: n.text || n.title,
                value: n.value
            }
      ...
      , Ja = y(Ya, ["left", "center", "right"], "align")
      , Qa = y(Ya, ["top", "middle", "bottom"], "valign")
      , Za = function(n, e) {
        var t, r, o, u, i = ti(n), c = ei(n), a = e ? (t = n.dom,
        {
            borderstyle: Y(i, "border-style").getOr(""),
            bordercolor: Ka(t)(Y(i, "border-color").getOr("")),
            backgroundcolor: Ka(t)(Y(i, "background-color").getOr(""))
        }) : {};
        return xn(xn(xn(xn(xn(xn({}, {
            height: "",
            width: "100%",
            cellspacing: "",
            cellpadding: "",
            ...
            align: "",
            border: ""
        }), i), c), a), (u = i["border-width"],
        ci(n) && u ? {
            border: u
        } : Y(c, "border").fold(function() {
            return {}
        }, function(n) {
            return {
                border: n
            }
        }))), (r = Y(i, "border-spacing").or(Y(c, "cellspacing")).fold(function() {
            return {}
        }, function(n) {
            return {
                cellspacing: n
        ...
        o = Y(i, "border-padding").or(Y(c, "cellpadding")).fold(function() {
            return {}
        }, function(n) {
            return {
                cellpadding: n
      ...
      , el = function(n) {
        return (0 < (e = Ua(n.getParam("table_cell_class_list", [], "array"))).length ? S.some({
            name: "class",
            type: "selectbox",
            label: "Class",
            items: e
        }) : S.none()).fold(function() {
            return nl
        }, function(n) {
            return nl.concat(n)
        });
      ...
      , ol = function(d, n, m) {
        var g = d.dom
          , p = 1 === n.length;
        E(n, function(n) {
            var e, t, r, o, u, i, c, a, l, f = m.celltype && mi(n) !== m.celltype ? g.rename(n, m.celltype) : n, s = p ? rl.normal(d, f) : rl.ifTruthy(d, f);
            t = m,
      ...
      , al = function(n) {
        return (0 < (e = Ua(n.getParam("table_row_class_list", [], "array"))).length ? S.some({
            name: "class",
            type: "selectbox",
            label: "Class",
            items: e
      ...
      , ll = function(i, n, c, a) {
        ...
        E(n, function(n) {
            ...
            var e, t, r, o, u = l ? rl.normal(i, n) : rl.ifTruthy(i, n);
            t = a,
      ...
      , dl = tinymce.util.Tools.resolve("tinymce.Env")
      , ml = function(n, e, t, r) {
        if ("TD" === e.tagName || "TH" === e.tagName)
            m(t) ? n.setStyle(e, t, r) : n.setStyle(e, t);
        else if (e.children)
            for (var o = 0; o < e.children.length; o++)
                ml(n, e.children[o], t, r)
    }
      , gl = function(t, r, n) {
        var o, u = t.dom, i = n.getData();
        n.close(),
        "" === i["class"] && delete i["class"],
        t.undoManager.transact(function() {
            if (!r) {
                var n = parseInt(i.cols, 10) || 1
            ...
            !function(n, e, t) {
                ...
                o.getAttrib(e, "width") && !ci(n) ? u.width = (r = t.width) ? r.replace(/px$/, "") : "" : i.width = bi(t.width),
                ci(n) ? (i["border-width"] = bi(t.border),
                i["border-spacing"] = bi(t.cellspacing)) : (u.border = t.border,
                ...
                ci(n) && e.children)
                    for (var c = 0; c < e.children.length; c++)
                        ...
                        ii(n) && ml(o, e.children[c], {
                            "border-color": t.bordercolor
                        });
                ii(n) && (i["background-color"] = t.backgroundcolor,
                i["border-color"] = t.bordercolor,
                i["border-style"] = t.borderstyle),
                u.style = o.serializeStyle(xn(xn({}, ti(n)), i)),
                o.setAttribs(e, xn(xn({}, ei(n)), u))
            }(t, r, i),
            (o = u.select("caption", r)[0]) && !i.caption && u.remove(o),
            !o && i.caption && ((o = u.create("caption")).innerHTML = dl.ie ? "\xa0" : '<br data-mce-bogus="1"/>',
      ...
      , pl = function(n, e) {
        var t, r, o, u, i, c, a, l, f = n.dom, s = Za(n, ii(n));
        !1 === e ? (t = f.getParent(n.selection.getStart(), "table")) ? (o = t,
        u = ii(r = n),
        l = r.dom,
        s = xn({
            ...
            cellpadding: l.getAttrib(o, "cellpadding") || Ha(r.dom, o, "padding"),
            border: (i = l,
            c = o,
            a = Te(Sn.fromDom(c), "border-width"),
            ci(r) && a.isSome() ? a.getOr("") : i.getAttrib(c, "border") || Ha(r.dom, c, "border-width") || Ha(r.dom, c, "border")),
            caption: !!l.select("caption", o)[0],
            "class": l.getAttrib(o, "class", ""),
            align: Ja(r, o)
        }, u ? $a(l, o) : {})) : ii(n) && (s.borderstyle = "",
        s.bordercolor = "",
        s.backgroundcolor = "") : (s.cols = "1",
        s.rows = "1",
        ii(n) && (s.borderstyle = "",
        s.bordercolor = "",
        s.backgroundcolor = ""));
        var d = Ua(n.getParam("table_class_list", [], "array"));
      ...
      , hl = function(a, t, l, f, e) {
        var r = vi(a)
          ...
          , i = function() {
            return Oa(a).map(function(r) {
                return o(r).bind(function(n) {
                    var e = Tr(f, n, r)
                      , t = Et(w, Sn.fromDom(a.getDoc()), S.none());
                    return Fa(n, e, t)
                })
            })
        }
          ...
          , s = function(c, n) {
            return n().each(function(n) {
                var i = k(n, function(n) {
                    return Dt(n)
                });
                Oa(a).each(function(u) {
                    return o(u).each(function(e) {
                        var n, t, r = Mt(Sn.fromDom(a.getDoc())), o = (n = i,
                        t = r,
                        {
                            selection: b(Sr(u, f)),
                            clipboard: b(n),
        ...
        K({
            ...
            mceTableDelete: function() {
                return Da(a).each(function(n) {
                    ct(n, r).filter(d(r)).each(function(n) {
                        var e = Sn.fromText("");
                        if (De(n, e),
                        Me(n),
            ...
            mceTableSizingMode: function(n, e) {
                ...
                Da(a).each(function(n) {
                    fi(a) || li(a) || ai(a) || ct(n, r).each(function(n) {
                        "relative" !== t || Vo(n) ? "fixed" !== t || Uo(n) ? "responsive" !== t || Ko(n) || Wi(n) : _i(a, n) : Ni(a, n),
                        wi(n)
                    })
                });
                var t
        ...
        a.addCommand("mceTableColType", function(n, e) {
            return Y(e, "type").each(function(n) {
                return u("th" === n ? t.makeColumnHeader : t.unmakeColumnHeader)
            })
        }),
        K({
        ...
        a.addCommand("mceInsertTable", function(n, e) {
            g(e) && 0 < V(e).length ? Na(a, e.rows, e.columns, e.options, "Invalid values for mceInsertTable - rows and columns values are required to insert a table.") : pl(a, !0)
        }),
        a.addCommand("mceTableApplyCellStyle", function(n, e) {
            if (g(e)) {
                var r = Aa(a);
                0 !== r.length && K(e, function(e, n) {
                    var t = "tablecell" + n.toLowerCase().replace("-", "");
                    a.formatter.has(t) && m(e) && E(r, function(n) {
      ...
      , Ol = {
        ...
        getWin: function(n) {
            ...
            return e = t,
            Sn.fromDom(e.dom().ownerDocument.defaultView)
        },
        range: Sl
    }
      , Dl = function(n, e) {
      ...
      , Bl = function(n, e, t, r, o) {
        var u = n.document.createRange();
        return u.setStart(e.dom(), t),
        u.setEnd(r.dom(), o),
        u
    }
      , Il = function(n) {
      ...
      , kl = function(n, e, t) {
        return e(Sn.fromDom(t.startContainer), t.startOffset, Sn.fromDom(t.endContainer), t.endOffset)
    }
      , El = function(n, e) {
        var o, t, r, u = (o = n,
        e.match({
        ...
        return (r = (t = u).ltr()).collapsed ? t.rtl().filter(function(n) {
            ...
            return Pl.rtl(Sn.fromDom(n.endContainer), n.endOffset, Sn.fromDom(n.startContainer), n.startOffset)
        }).getOrThunk(function() {
    ...
    function(n, e, t) {
      ...
      , _l = function(t, r, n, e, o) {
        var u = function(n) {
            var e = t.dom().createRange();
            return e.setStart(r.dom(), n),
            e.collapse(!0),
            e
        }
          , i = ht(r).length
      ...
      , ql = document.caretPositionFromPoint ? function(t, n, e) {
        return S.from(t.dom().caretPositionFromPoint(n, e)).bind(function(n) {
            if (null === n.offsetNode)
                return S.none();
            var e = t.dom().createRange();
            return e.setStart(n.offsetNode, n.offset),
            e.collapse(),
            S.some(e)
        })
    }
    : document.caretRangeFromPoint ? function(n, e, t) {
    ...
    : function(o, u, e) {
        return Sn.fromPoint(o, u, e).bind(function(r) {
            var n = function() {
                return n = o,
                t = u,
                (0 === ae(e = r).length ? Ll : Fl)(n, e, t);
                var n, e, t
            };
            return 0 === ae(r).length ? n() : Hl(o, r, u, e).orThunk(n)
        })
    }
      , Vl = function(n, e) {
        var t = Q(n);
        return "input" === t ? Tl.after(n) : B(["br", "img"], t) ? 0 === e ? Tl.before(n) : Tl.after(n) : Tl.on(n, e)
    }
      , Ul = function(n, e) {
        var t = n.fold(Tl.before, Vl, Tl.after)
          , r = e.fold(Tl.before, Vl, Tl.after);
      ...
      , $l = function(n, e, t, r) {
        ...
        i = t,
        c = r,
        (a = re(o = n).dom().createRange()).setStart(o.dom(), u),
        a.setEnd(i.dom(), c),
        a), f = Zn(n, t) && e === r;
      ...
      , Yl = function(s, n) {
        return El(s, n).match({
            ...
            rtl: function(n, e, t, r) {
                var o, u, i, c, a, l = s.getSelection();
                if (l.setBaseAndExtent)
                    l.setBaseAndExtent(n.dom(), e, t.dom(), r);
                else if (l.extend)
                    try {
                        u = n,
                        i = e,
      ...
      , Zl = function(n) {
        var o = Ol.getWin(n).dom()
          , e = function(n, e, t, r) {
            return Bl(o, n, e, t, r)
        }
          , t = n.match({
            domRange: function(n) {
                var e = Sn.fromDom(n.startContainer)
                  , t = Sn.fromDom(n.endContainer);
      ...
      , nf = function(n) {
        var e = Sn.fromDom(n.anchorNode)
          , t = Sn.fromDom(n.focusNode);
        return $l(e, n.anchorOffset, t, n.focusOffset) ? S.some(Sl(e, n.anchorOffset, t, n.focusOffset)) : function(n) {
            if (0 < n.rangeCount) {
                var e = n.getRangeAt(0)
                  , t = n.getRangeAt(n.rangeCount - 1);
                return S.some(Sl(Sn.fromDom(e.startContainer), e.startOffset, Sn.fromDom(t.endContainer), t.endOffset))
            }
            return S.none()
        }(n)
    }
      ...
      , tf = function(n) {
        return e = n,
        S.from(e.getSelection()).filter(function(n) {
            return 0 < n.rangeCount
        }).bind(nf).map(function(n) {
      ...
      , rf = function(n, e) {
        ...
        0 < (o = 0 < r.length ? r[0] : t.getBoundingClientRect()).width || 0 < o.height ? S.some(o).map(Il) : S.none()
    }
      , of = function(n, e, t) {
        return r = n,
        o = e,
        ...
        ql(i, o, u).map(function(n) {
            return Sl(Sn.fromDom(n.startContainer), n.startOffset, Sn.fromDom(n.endContainer), n.endOffset)
        });
        var r, o, u, i
    }
      , uf = tinymce.util.Tools.resolve("tinymce.util.VK")
      , cf = function(n, e, t, r) {
        return ff(n, e, Cl(o = t, u).fold(function() {
            return yl.none(o)
        }, function(n) {
            return n.index + 1 < n.all.length ? yl.middle(o, n.all[n.index + 1]) : yl.last(o)
        }), r);
        var o, u
    }
      , af = function(n, e, t, r) {
        return ff(n, e, Cl(o = t, u).fold(function() {
            ...
            return 0 <= n.index - 1 ? yl.middle(o, n.all[n.index - 1]) : yl.first(o)
        }), r);
        var o, u
    }
      , lf = function(n, e) {
        var t = Ol.exact(e, 0, e, 0);
        return Zl(t)
    }
      , ff = function(o, n, e, u, t) {
        return e.fold(S.none, S.none, function(n, e) {
      ...
      , df = function(e, t, r, o) {
        if (e.keyCode === uf.TAB) {
            ...
            if (n.collapsed) {
                var c = Sn.fromDom(n.startContainer);
      ...
      , pf = function(n, e) {
        var t = Ml(n, e);
        return Sl(Sn.fromDom(t.startContainer), t.startOffset, Sn.fromDom(t.endContainer), t.endOffset)
    }
      , hf = gf
      , vf = function(t, n, r, e, o) {
        return Zn(r, e) ? S.none() : nr(r, e, n).bind(function(n) {
            var e = n.boxes.getOr([]);
            return 0 < e.length ? (o(t, e, n.start, n.finish),
            S.some(mf(S.some(hf(r, 0, r, wt(r))), !0))) : S.none()
        })
    }
      , bf = function(n, e) {
        return {
      ...
      , wf = function(n, e, t, r) {
        return void 0 === r && (r = yf),
        n.property().parent(e).map(function(n) {
            return bf(n, r)
        })
    }
      , yf = function(n, e, t, r) {
        return void 0 === r && (r = Cf),
      ...
      , xf = function(e, t, r, o, n) {
        return void 0 === n && (n = Sf),
        W(n, function(n) {
            return n.current === r
        }).bind(function(n) {
      ...
      , Tf = function() {
        return {
            ...
            first: function(n) {
                return 0 < n.length ? S.some(n[n.length - 1]) : S.none()
            }
        }
    }
      , Rf = function() {
        return {
            ...
            first: function(n) {
                return 0 < n.length ? S.some(n[0]) : S.none()
            }
        }
    }
      , Of = function(e, n, t, r, o, u) {
        return xf(e, n, r, o).bind(function(n) {
            return u(n.item()) ? S.none() : t(n.item()) ? S.some(n.item()) : Of(e, n.item(), t, n.mode(), o, u)
        })
    }
      , Df = function(e) {
        return function(n) {
      ...
      , Nf = xn(xn({}, Ef), {
        verify: function(c, n, e, t, r, a, o) {
            return Ge(t, "td,th", o).bind(function(i) {
                return Ge(n, "td,th", o).map(function(u) {
                    return Zn(i, u) ? Zn(t, i) && wt(i) === r ? a(u) : Ef.none("in same cell") : Qt(Mf, [i, u]).fold(function() {
                        return e = u,
                        t = i,
                        r = (n = c).getRect(e),
                        (o = n.getRect(t)).right > r.left && o.left < r.right ? Ef.success() : a(u);
                        var n, e, t, r, o
                    }, function(n) {
                        return a(u)
                    })
      ...
      , zf = function(n, e, t) {
        return e(n, t).bind(function(n) {
            return rn(n) && 0 === ht(n).trim().length ? zf(n, e, t) : S.some(n)
        })
    }
      , Ff = function(e, n, t, r) {
        return le(o = n, u = t).filter(jf).orThunk(function() {
      ...
      , Lf = function(n, e, t, r) {
        ...
        return (jf(e) ? (o = n,
        u = e,
        (i = r).traverse(u).orThunk(function() {
            return zf(u, i.gather, o)
        }).map(i.relative)) : Ff(n, e, t, r)).map(function(n) {
            return {
                start: b(n),
                finish: b(n)
            }
      ...
      , $f = function(n, e, t) {
        return tn(e) ? Kf(n, e).map(Uf) : rn(e) ? (r = n,
        o = e,
        (0 <= (u = t) && u < wt(o) ? r.getRangedRect(o, u, o, u + 1) : 0 < u ? r.getRangedRect(o, u - 1, o, u) : S.none()).map(Uf)) : S.none();
        var r, o, u
    }
      , Xf = function(n, e) {
        return tn(e) ? Kf(n, e).map(Uf) : rn(e) ? n.getRangedRect(e, 0, e, wt(e)).map(Uf) : S.none()
    }
      , Gf = hr([{
        none: []
    }, {
      ...
      , Yf = function(e, n, r) {
        return Ve(function(n, e) {
            return e(n)
        }, Ue, n, Hc, t).fold(b(!1), function(n) {
            return Xf(e, n).exists(function(n) {
                return t = n,
                (e = r).left < t.left || Math.abs(t.right - e.left) < 1 || e.left > t.right;
                var e, t
            })
        });
        var t
      ...
      , Jf = {
        ...
        adjuster: function(n, e, t, r, o) {
            var u = Hf(o, 5);
            return Math.abs(t.bottom - r.bottom) < 1 || t.top > o.bottom ? Gf.retry(u) : t.top === o.bottom ? Gf.retry(Hf(o, 1)) : Yf(n, e, o) ? Gf.retry(Vf(u, 5, 0)) : Gf.none()
        },
        move: Hf,
        gather: kf
    }
      , Qf = function(t, r, o, u, i) {
        return 0 === i ? S.some(u) : (a = t,
        l = u.left,
        f = r.point(u),
        a.elementFromPoint(l, f).filter(function(n) {
            return "table" === Q(n)
        }).isSome() ? (e = u,
        c = i - 1,
        Qf(t, n = r, o, n.move(e, 5), c)) : t.situsFromPoint(u.left, r.point(u)).bind(function(n) {
            return n.start().fold(S.none, function(e) {
                return Xf(t, e).bind(function(n) {
                    return r.adjuster(t, e, n, o, u).fold(S.none, function(n) {
      ...
      , Zf = function(e, t, n) {
        var r, o, u, i = e.move(n, 5), c = Qf(t, e, n, i, 100).getOr(i);
        return o = c,
        u = t,
        ((r = e).point(o) > u.getInnerHeight() ? S.some(r.point(o) - u.getInnerHeight()) : r.point(o) < 0 ? S.some(-r.point(o)) : S.none()).fold(function() {
      ...
      , ns = {
        tryUp: y(Zf, {
            ...
            adjuster: function(n, e, t, r, o) {
                var u = qf(o, 5);
                return Math.abs(t.top - r.top) < 1 || t.bottom < o.top ? Gf.retry(u) : t.bottom === o.top ? Gf.retry(qf(o, 1)) : Yf(n, e, o) ? Gf.retry(Vf(u, 5, 0)) : Gf.none()
            },
            move: qf,
            gather: Pf
        }),
      ...
      , es = function(u, i, c) {
        return u.getSelection().bind(function(o) {
            return Lf(i, o.finish(), o.foffset(), c).fold(function() {
                return S.some(Fi(o.finish(), o.foffset()))
            }, function(n) {
                var e, t = u.fromSitus(n), r = Nf.verify(u, o.finish(), o.foffset(), t.finish(), t.foffset(), c.failure, i);
                return e = r,
                Nf.cata(e, function(n) {
                    return S.none()
                }, function() {
                    return S.none()
                }, function(n) {
      ...
      , ts = function(r, o, u, i, c, a) {
        return 0 === a ? S.none() : us(r, o, u, i, c).bind(function(n) {
            var e = r.fromSitus(n)
              , t = Nf.verify(r, u, i, e.finish(), e.foffset(), c.failure, o);
            return Nf.cata(t, function() {
                return S.none()
            }, function() {
                return S.some(n)
            }, function(n) {
                return Zn(u, n) && 0 === i ? rs(r, u, i, qf, c) : ts(r, o, n, 0, c, a - 1)
            }, function(n) {
                return Zn(u, n) && i === wt(n) ? rs(r, u, i, Hf, c) : ts(r, o, n, wt(n), c, a - 1)
            })
        })
    }
      , rs = function(e, n, t, r, o) {
      ...
      , os = function(n, e, t) {
        var r = Yn().browser;
        return r.isChrome() || r.isSafari() || r.isFirefox() || r.isEdge() ? e.otherRetry(n, t) : r.isIE() ? e.ieRetry(n, t) : S.none()
    }
      , us = function(e, n, t, r, o) {
      ...
      , cs = function(u, i, c, n, a) {
        return Ge(n, "td,th", i).bind(function(o) {
            return Ge(o, "table", i).bind(function(n) {
                return is(a, n) ? es(e = u, t = i, r = c).bind(function(n) {
                    return ts(e, t, n.element(), n.offset(), r, 20).map(e.fromSitus)
                }).bind(function(e) {
      ...
      , as = function(n, e, t, r, o, u) {
        return Yn().browser.isIE() ? S.none() : u(r, e).orThunk(function() {
            return cs(n, e, t, r, o).map(function(n) {
                var e = n.range();
                return mf(S.some(hf(e.start(), e.soffset(), e.finish(), e.foffset())), !0)
            })
        })
    }
      , ls = function(n, r) {
        return Ge(n, "tr", r).bind(function(t) {
            return Ge(t, "table", r).bind(function(n) {
                var e = qe(n, "tr");
                return Zn(t, e[0]) ? Af(If, n, function(n) {
                    return xt(n).isSome()
                }, r).map(function(n) {
                    var e = wt(n);
      ...
      , fs = function(n, r) {
        return Ge(n, "tr", r).bind(function(t) {
            return Ge(t, "table", r).bind(function(n) {
                var e = qe(n, "tr");
                return Zn(t, e[e.length - 1]) ? Bf(If, n, function(n) {
                    return St(n).isSome()
                }, r).map(function(n) {
    ...
    var ms = {
      ...
      , Ss = function(c) {
        return {
            ...
            fromSitus: function(n) {
                var e = Ol.relative(n.start(), n.finish());
                return pf(c, e)
            },
            ...
            scrollBy: function(n, e) {
                ...
                t = n,
                r = e,
                ((o = Sn.fromDom(c.document)) !== undefined ? o.dom() : h.document).defaultView.scrollBy(t, r)
            }
        }
    }
      , xs = function(n, e) {
                    ...
                    t.each(function(r) {
                        ...
                        ds(n.target(), e).each(function(t) {
                            nr(r, t, e).each(function(n) {
                                var e = n.boxes.getOr([]);
                                (1 < e.length || 1 === e.length && !Zn(r, t)) && (i.selectRange(u, e, n.start, n.finish),
                                o.selectContents(t))
                            })
                        })
                    })
        ...
        return {
            keydown: function(n, e, t, r, o, i) {
                ...
                return er(g, h.selectedSelector).fold(function() {
                    return vs(c) && a ? y(ss, l, g, p, ms, r, e, h.selectRange) : hs(c) && a ? y(ss, l, g, p, gs, r, e, h.selectRange) : vs(c) ? y(as, l, p, ms, r, e, fs) : hs(c) ? y(as, l, p, gs, r, e, ls) : S.none
                }, function(u) {
                    var n = function(n) {
                        return function() {
                            return q(n, function(n) {
                                ...
                                t = n.cols,
                                r = g,
                                rr(u, e, t, (o = h).firstSelectedSelector, o.lastSelectedSelector).map(function(n) {
                                    return o.clearBeforeUpdate(r),
                                    o.selectRange(r, n.boxes, n.start, n.finish),
                                    n.boxes
                                });
                                var e, t, r, o
                            }).fold(function() {
                                return tr(g, h.firstSelectedSelector, h.lastSelectedSelector).map(function(n) {
                                    var e = vs(c) || i.isForward(c) ? Tl.after : Tl.before;
                                    return l.setRelativeSelection(Tl.on(n.first(), 0), e(n.table())),
                                    h.clear(g),
                                    mf(S.none(), !0)
                                })
                            }, function(n) {
                    ...
                    return vs(c) && a ? n([xs(1, 0)]) : hs(c) && a ? n([xs(-1, 0)]) : i.isBackward(c) && a ? n([xs(0, -1), xs(-1, 0)]) : i.isForward(c) && a ? n([xs(0, 1), xs(1, 0)]) : bs(c) && !1 == a ? f : S.none
                })()
            },
            keyup: function(l, f, s, d, m) {
                return er(g, h.selectedSelector).fold(function() {
                    var t, r, n, e, o, u, i, c = l.raw(), a = c.which;
                    return !1 != (!0 === c.shiftKey) && bs(a) ? (t = g,
                    r = p,
                    n = f,
                    e = s,
                    o = d,
                    u = m,
                    i = h.selectRange,
                    Zn(n, o) && e === u ? S.none() : Ge(n, "td,th", r).bind(function(e) {
      ...
      , As = {
        byClass: function(o) {
            var e, t, u = (e = o.selected,
            function(n) {
                gu(n, e)
            }
            ), r = (t = [o.selected, o.lastSelected, o.firstSelected],
            function(n) {
                Ds(n, t)
            }
            ), i = function(n) {
                var e = qe(n, o.selectedSelector);
                E(e, r)
            };
            return {
                clearBeforeUpdate: i,
      ...
      , Bs = function(n, e, s) {
        ...
        return mc(d, e).map(function(n) {
            var t, e, r, o, u, i, c, a, l, f = ic(d, s, !1);
            return {
                upOrLeftCells: (t = n,
                e = s,
    ...
    function Ps(d, m, n) {
        var g = As.byAttr(pr, function(u, i, c) {
            n.targets().each(function(o) {
                ct(i).each(function(n) {
                    var e = di(d)
                      , t = Et(w, Sn.fromDom(d.getDoc()), e)
                      , r = Bs(n, o, t);
                    Gu(d, u, i, c, r)
                })
            })
        ...
        return d.on("init", function(n) {
            ...
            var i, a, l = function(n, e) {
                !0 === n.raw().shiftKey && (e.kill() && n.kill(),
            ...
            a = Ri(0),
            {
                touchEnd: function(n) {
                    ...
                    if ("td" === Q(e) || "th" === Q(e)) {
                        var t = i.get()
                          , r = a.get();
                        Zn(t, e) && n.timeStamp - r < 300 && (n.preventDefault(),
                        u(e, e))
                    }
                    i.set(e),
                    a.set(n.timeStamp)
            ...
            d.on("mouseover", function(n) {
                var e;
                ((e = n).buttons === undefined || dl.browser.isEdge() && 0 === e.buttons || 0 != (1 & e.buttons)) && Is(n) && t.mouseover(lu(n))
            }),
            ...
            d.on("keyup", function(n) {
                ...
                if (e.raw().shiftKey && bs(e.raw().which)) {
                    var t = d.selection.getRng()
                      , r = Sn.fromDom(t.startContainer)
                      , o = Sn.fromDom(t.endContainer);
            ...
            d.on("keydown", function(n) {
                ...
                var t = d.selection.getRng()
                  , r = Sn.fromDom(d.selection.getStart())
                  , o = Sn.fromDom(t.startContainer)
                  , u = Sn.fromDom(t.endContainer)
                  , i = Ti(r).isRtl() ? ys : ws;
                c.keydown(e, o, t.startOffset, u, t.endOffset, i).each(function(n) {
                    l(e, n)
                }),
                m().each(function(n) {
                    return n.showBars()
            ...
            d.on("NodeChange", function() {
                var n = d.selection
                  , e = Sn.fromDom(n.getStart())
                  , t = Sn.fromDom(n.getEnd());
    ...
    var ks = function(n, t) {
        var o = Ri(S.none())
          ...
          , e = function() {
            return Da(n).bind(function(e) {
                var n = ct(e);
                return n.map(function(n) {
                    return "caption" === Q(e) ? xr(e) : Tr(t, n, e)
                })
            })
        }
          , r = function() {
          ...
          , i = function(e, t) {
            ...
            function() {
                u.set(M(u.get(), function(n) {
                    return n !== r
                }))
            }
        };
        return n.on("NodeChange ExecCommand TableSelectorChange", r),
        {
            ...
            onSetupCellOrRow: function(n) {
                return i(n, function(n) {
                    return "caption" === Q(n.element())
                })
            },
            onSetupPasteable: function(e) {
                return function(n) {
                    return i(n, function(n) {
                        return "caption" === Q(n.element()) || e().isNone()
                    })
                }
            },
      ...
      , Ms = function(e) {
        var n = e.getParam("table_toolbar", "tableprops tabledelete | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol");
        0 < n.length && e.ui.registry.addContextToolbar("table", {
      ...
      , Ns = function(r, n, e) {
        ...
        r.ui.registry.addContextMenu("table", {
            update: function() {
                return n.resetTargets(),
                n.targets().fold(function() {
                    return ""
                }, function(n) {
                    return "caption" === Q(n.element()) ? "tableprops deletetable" : "cell row column | advtablesort | tableprops deletetable"
                })
            }
        })
    }
    ...
    function js(e) {
        ...
        e.on("PreInit", function() {
            e.serializer.addTempAttr(sr),
            e.serializer.addTempAttr(mr),
            Ws(e)
        }),
        ri(e) && e.on("keydown", function(n) {
            df(n, e, u, r.lazyWire)
        }),
