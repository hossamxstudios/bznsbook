...
!function(f) {
    ...
    var n, r, e, o = function() {}, a = function(t) {
        return function() {
            return t
        }
    }, i = function(t) {
        return t
    }, c = a(!1), s = a(!0), l = function() {
        return d
    }, d = (n = function(t) {
        return t.isNone()
    }
    ,
    {
        ...
        return function(t) {
            return r = typeof (n = t),
            (null === n ? "null" : "object" == r && (Array.prototype.isPrototypeOf(n) || n.constructor && "Array" === n.constructor.name) ? "array" : "object" == r && (String.prototype.isPrototypeOf(n) || n.constructor && "String" === n.constructor.name) ? "string" : r) === e;
            var n, r
        }
    }, p = g("string"), h = g("object"), v = g("array"), b = Array.prototype.slice, k = Array.prototype.indexOf, O = function(t, n) {
        return r = t,
        e = n,
        -1 < k.call(r, e);
        var r, e
        ...
        return !0
    }, N = Object.keys, P = Object.hasOwnProperty, S = (function(i) {
        if (!v(i))
        ...
        C(i, function(t, e) {
            ...
            r[o] = function() {
                ...
                if (t !== a.length)
                    throw new Error("Wrong number of arguments to case " + o + ". Expected " + a.length + " (" + a + "), got " + t);
    ...
    function(t) {
        ...
        var a = function(t) {
          ...
          , t = function(t, n, r) {
            if (o.format === undefined)
                return o.cmd !== undefined ? p(o.cmd) ? B.value(r(o.cmd, o.value)) : a(t + " pattern has non-string `cmd` parameter") : a(t + " pattern is missing both `format` and `cmd` parameters");
            var e = void 0;
            if (v(o.format)) {
                if (!T(o.format, p))
        ...
        if (!h(o))
            return a("Raw pattern is not an object");
        if (!p(o.start))
            return a("Raw pattern is missing `start` parameter");
        if (o.end === undefined)
            return o.replacement !== undefined ? p(o.replacement) ? 0 === o.start.length ? a("Replacement pattern has empty `start` parameter") : B.value({
                type: "inline-command",
                start: "",
                end: o.start,
        ...
        return {
            inlinePatterns: E(t, D),
            blockPatterns: j(E(t, I))
        }
    }, L = function(e) {
        return {
    ...
    }, V = "undefined" != typeof f.window ? f.window : Function("return this;")(), W = function() {
        ...
        return !1 === n ? "" : !0 === n ? "p" : n
    }, H = tinymce.util.Tools.resolve("tinymce.util.Delay"), J = tinymce.util.Tools.resolve("tinymce.util.VK"), K = tinymce.util.Tools.resolve("tinymce.util.Tools"), X = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), z = tinymce.util.Tools.resolve("tinymce.dom.TextSeeker"), Q = function(t, n) {
        return {
            container: t,
            offset: n
        }
        ...
        n.deleteContents(),
        e && !r(n.startContainer) && (Y(n.startContainer) && 0 === n.startContainer.data.length && t.remove(n.startContainer),
        Y(n.endContainer) && 0 === n.endContainer.data.length && t.remove(n.endContainer),
        Z(t, o, r),
        o !== a && Z(t, a, r))
    }, tt = function(t, n) {
        var r, e = n.get(t);
        return v(e) && (0 === (r = e).length ? y.none() : y.some(r[0])).exists(function(t) {
            return n = t,
            r = "block",
            P.call(n, r);
            var n, r
        ...
        if (0 !== t.length) {
            ...
            C(t, function(t) {
                ...
                e = (n = i).dom,
                o = r.pattern,
                a = dt(e.getRoot(), r.range).getOrDie("Unable to resolve path range"),
        ...
        var r = t.createRng();
        return r.setStartAfter(n.start),
        r.setEndBefore(n.end),
        r
    }, bt = function(t, n, r) {
        ...
        var i, u = o.start;
        return ft(e, t.container, t.offset, (i = u,
        function(t, n) {
            ...
            if (r.offset >= u.length) {
                var t = e.createRng();
                return t.setStart(r.container, r.offset - u.length),
                ...
                0 !== r.start.length || a)
                    return at(n, e, o).bind(function(n) {
                        return Ot(t, r, o, n).bind(function(t) {
                            if (a) {
                                if (t.endContainer === n.container && t.endOffset === n.offset)
                                    return y.none();
        ...
        "inline-format" === t.type ? C(t.format, function(t) {
            n.formatter.apply(t)
        }) : n.execCommand(t.cmd, !1, t.value)
    }, xt = function(o, t) {
        var n, r, a = (n = "mce_textpattern",
        r = (new Date).getTime(),
        n + "_" + Math.floor(1e9 * Math.random()) + ++ht + String(r)), i = x(t, function(t, n) {
            var r = bt(o, a + "_end" + t.length, n.endRng);
            return t.concat([u(u({}, n), {
                endMarker: r
            })])
        }, []);
        return x(i, function(t, n) {
        ...
        if (0 !== t.length) {
            var c = f.dom
              ...
              , r = xt(c, t);
            C(r, function(t) {
                var n, r, e, o, a, i = c.getParent(t.startMarker.start, c.isBlock), u = function(t) {
                    return t === i
                };
                nt(t.pattern) ? (n = f,
                r = t.pattern,
        ...
        n.on("keydown", function(t) {
            13 !== t.keyCode || J.modifierPressed(t) || !function(r, t) {
                ...
                return (0 < o.length || 0 < e.length) && (r.undoManager.add(),
                r.undoManager.extra(function() {
                    ...
                    n.each(function(t) {
                        var n = t.container;
                        "\ufeff" === n.data.charAt(t.offset - 1) && (n.deleteData(t.offset - 1, 1),
    ...
    !function Mt() {
        t.add("textpattern", function(t) {
            var n, r, e = (n = function(t) {
                ...
                if (!v(n))
                    return W("The setting textpattern_patterns should be an array"),
                    {
                        inlinePatterns: [],
                        blockPatterns: []
                    };
                var r = S(w(n, _));
                return C(r.errors, function(t) {
