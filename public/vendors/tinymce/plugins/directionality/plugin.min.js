...
!function(u) {
    "use strict";
    var n, t, e, o, r = tinymce.util.Tools.resolve("tinymce.PluginManager"), i = tinymce.util.Tools.resolve("tinymce.util.Tools"), c = function(n, t) {
        var e, o = n.dom, r = n.selection.getSelectedBlocks();
        r.length && (e = o.getAttrib(r[0], "dir"),
        i.each(r, function(n) {
    ...
    ,
    {
        ...
        none: m,
        from: function(n) {
            return null === n || n === undefined ? a : s(n)
        }
    }, h = function(n) {
        ...
        fromHtml: function(n, t) {
            ...
            !e.hasChildNodes() || 1 < e.childNodes.length)
                throw u.console.error("HTML does not have a single root node", n),
    ...
    ), p = ("undefined" != typeof u.window ? u.window : Function("return this;")(),
    function(t) {
        return function(n) {
            return n.dom().nodeType === t
        }
    }
    ), T = p(3), w = p(9), N = p(11), D = v(u.Element.prototype.attachShadow) && v(u.Node.prototype.getRootNode) ? function(n) {
        return y.fromDom(n.dom().getRootNode())
    }
    : function(n) {
        return w(n) ? n : (t = n,
        y.fromDom(t.dom().ownerDocument));
        var t
    }
    , O = function(n) {
        var t = D(n);
        ...
        var t, e, o = T(n) ? n.dom().parentNode : n.dom();
        return o !== undefined && null !== o && null !== o.ownerDocument && O(y.fromDom(o)).fold(function() {
        ...
        o = (t = n).dom(),
        "" !== (r = u.window.getComputedStyle(o).getPropertyValue(e)) || S(t) ? r : L(o, e)) ? "rtl" : "ltr";
        var t, e, o, r
    }, A = function(t, o) {
        return function(e) {
            var n = function(n) {
