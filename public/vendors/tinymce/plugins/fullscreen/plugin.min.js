...
!function(p) {
    ...
    }, r = tinymce.util.Tools.resolve("tinymce.PluginManager"), i = function(n) {
        return {
            isFullscreen: function() {
                return null !== n.get()
            }
        }
    }, o = function() {}, a = function(n) {
        return function() {
            return n
        }
    }, f = a(!1), u = a(!0), l = function() {
        return d
    }, d = (n = function(n) {
        return n.isNone()
    }
    ,
    {
        ...
        return function(n) {
            return e = typeof (t = n),
            (null === t ? "null" : "object" == e && (Array.prototype.isPrototypeOf(t) || t.constructor && "Array" === t.constructor.name) ? "array" : "object" == e && (String.prototype.isPrototypeOf(t) || t.constructor && "String" === t.constructor.name) ? "string" : e) === r;
            var t, e
        }
    }, v = function(t) {
        return function(n) {
    ...
    }, y = g("string"), w = g("array"), b = v("boolean"), S = function(n) {
        return !(null === (t = n) || t === undefined);
        var t
    }, T = v("function"), x = v("number"), D = Array.prototype.push, E = function(n, t) {
        ...
        fromHtml: function(n, t) {
            var e = (t || p.document).createElement("div");
            if (e.innerHTML = n,
            !e.hasChildNodes() || 1 < e.childNodes.length)
                throw p.console.error("HTML does not have a single root node", n),
                new Error("HTML must have a single root node");
            return k(e.childNodes[0])
        },
        fromTag: function(n, t) {
            var e = (t || p.document).createElement(n);
            return k(e)
        },
        fromText: function(n, t) {
            var e = (t || p.document).createTextNode(n);
            return k(e)
        },
        fromDom: k,
    ...
    }, P = ("undefined" != typeof p.window ? p.window : Function("return this;")(),
    function(t) {
        return function(n) {
            return n.dom().nodeType === t
        }
    }
    ), L = P(1), H = P(3), q = P(9), V = P(11), W = function(n, t) {
        var e = n.dom();
        if (1 !== e.nodeType)
            return !1;
        var r = e;
        ...
        var n;
        return n = e,
        m.from(n.dom().parentNode).map(F.fromDom).map(z).map(function(n) {
    ...
    }, B = T(p.Element.prototype.attachShadow) && T(p.Node.prototype.getRootNode), I = a(B), R = B ? function(n) {
        return F.fromDom(n.dom().getRootNode())
    }
    : function(n) {
        return q(n) ? n : (t = n,
        F.fromDom(t.dom().ownerDocument));
        var t
    }
    , U = function(n) {
        var t = R(n);
        ...
        var t, e, r = H(n) ? n.dom().parentNode : n.dom();
        return r !== undefined && null !== r && null !== r.ownerDocument && U(F.fromDom(r)).fold(function() {
        ...
        !function(n, t, e) {
            if (!(y(e) || b(e) || x(e)))
                throw p.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", e, ":: Element ", n),
        ...
        var e = n.dom();
        !function(n, t) {
            for (var e = C(n), r = 0, o = e.length; r < o; r++) {
                var u = e[r];
                t(n[u], u)
            }
        }(t, function(n, t) {
            !function(n, t, e) {
                if (!y(e))
                    throw p.console.error("Invalid call to CSS.set. Property ", t, ":: Value ", e, ":: Element ", n),
        ...
        var e, r, t, o, u, i = F.fromDom(K(n).getOr(n.target)), c = function() {
        ...
        var t, e, r, o, u = n === undefined ? p.window : n, i = u.document, c = (t = F.fromDom(i),
        ...
        en(r, o));
        return rn(u).fold(function() {
            var n = u.document.documentElement
              , t = n.clientWidth
              , e = n.clientHeight;
            return on(c.left(), c.top(), t, e)
        }, function(n) {
            return on(Math.max(n.pageLeft, c.left()), Math.max(n.pageTop, c.top()), n.width, n.height)
        })
    }, cn = function(e, r, n) {
        return rn(n).map(function(n) {
            var t = function(n) {
                return r(nn(n))
            };
    ...
    }, fn = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), ln = tinymce.util.Tools.resolve("tinymce.Env"), an = tinymce.util.Tools.resolve("tinymce.util.Delay"), dn = function(n, t) {
        n.fire("FullscreenStateChanged", {
            state: t
        })
    }, sn = function(n, t, e) {
        return N(function(n, t) {
            for (var e = T(t) ? t : f, r = n.dom(), o = []; null !== r.parentNode && r.parentNode !== undefined; ) {
                var u = r.parentNode
                  , i = F.fromDom(u);
                if (o.push(i),
                !0 === e(i))
        ...
        1 !== (r = o).nodeType && 9 !== r.nodeType && 11 !== r.nodeType || 0 === r.childElementCount ? [] : E(o.querySelectorAll(t), F.fromDom);
        var t, e, r, o
    }, hn = function(n, t) {
        return e = function(n) {
            return W(n, t)
        ...
        N(j(n), e);
        var e
    }, pn = "data-ephox-mobile-fullscreen-style", gn = "position:absolute!important;", vn = "top:0!important;left:0!important;margin:0!important;padding:0!important;width:100%!important;height:100%!important;overflow:visible!important;", yn = ln.os.isAndroid(), wn = function(n) {
        var t, e, r, o, u = (e = "background-color",
        r = (t = n).dom(),
        "" !== (o = p.window.getComputedStyle(r).getPropertyValue(e)) || Y(t) ? o : $(r, e));
        return u !== undefined && "" !== u ? "background-color:" + u + "!important" : "background-color:rgb(255,255,255)!important;"
    }, bn = function(o, n, t) {
        var e, r, u = function(r) {
            return function(n) {
                var t = J(n, "style")
        ...
        }), o = h(), u = h(), i = an.throttle(function() {
        ...
        var e, r, o = p.document.body, u = p.document.documentElement, i = t.getContainer(), c = F.fromDom(i), f = n.get(), l = F.fromDom(t.getBody()), a = ln.deviceType.isTouch(), d = i.style, s = t.iframeElement.style, m = function() {
            var e, n;
            a && (e = t.dom,
            n = mn("[" + pn + "]"),
            A(n, function(n) {
                var t = J(n, pn);
                "no-styles" !== t ? Z(n, e.parseStyle(t)) : Q(n, "style"),
                Q(n, pn)
            })),
        ...
        return function(t) {
            ...
            return e.on("FullscreenStateChanged", n),
            function() {
