...
!function(e) {
    "use strict";
    var n, t, a, r = tinymce.util.Tools.resolve("tinymce.PluginManager"), i = function(e) {
        return function() {
            return e
        }
    }, s = i(!1), o = i(!0), l = function() {
        return u
    }, u = (n = function(e) {
        return e.isNone()
    }
    ...
    !function(n, t, a, d) {
        ...
        function(e) {
            if ("object" == typeof t && void 0 !== a)
                a.exports = e();
            else if ("function" == typeof n && n.amd)
                n([], e);
            else {
                ("undefined" != typeof window ? window : void 0 !== y ? y : "undefined" != typeof self ? self : this).EphoxContactWrapper = e()
            }
        }(function() {
            return function c(i, s, o) {
                ...
                for (var u = "function" == typeof d && d, e = 0; e < o.length; e++)
                    l(o[e]);
                return l
            }({
                1: [function(e, n, t) {
                        ...
                        var n = function(u) {
                            var c = /\blang(?:uage)?-([\w-]+)\b/i
                              ...
                              , C = {
                                ...
                                util: {
                                    encode: function(e) {
                                        return e instanceof O ? new O(e.type,C.util.encode(e.content),e.alias) : Array.isArray(e) ? e.map(C.util.encode) : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                                    },
                                    type: function(e) {
                                    ...
                                    DFS: function l(e, n, t, a) {
                                        ...
                                        for (var i in e)
                                            if (e.hasOwnProperty(i)) {
                                                ...
                                                var s = e[i]
                                                  , o = C.util.type(s);
                                                "Object" !== o || a[r(s)] ? "Array" !== o || a[r(s)] || (a[r(s)] = !0,
                                                l(s, n, i, a)) : (a[r(s)] = !0,
                                                l(s, n, null, a))
                                            }
                                    }
                                ...
                                highlightElement: function(e, n, t) {
                                    ...
                                    var i = e.parentNode;
                                    i && "pre" === i.nodeName.toLowerCase() && (i.className = i.className.replace(c, "").replace(/\s+/g, " ") + " language-" + a);
                                    var s = {
                                        element: e,
                                        language: a,
                                        grammar: r,
                                    ...
                                    if (C.hooks.run("before-sanity-check", s),
                                    !s.code)
                                        return C.hooks.run("complete", s),
                                        void (t && t.call(s.element));
                                    if (C.hooks.run("before-highlight", s),
                                    s.grammar)
                                        if (n && u.Worker) {
                                            ...
                                            o(C.highlight(s.code, s.grammar, s.language));
                                    else
                                        o(C.util.encode(s.code))
                                },
                                highlight: function(e, n, t) {
                                    ...
                                    return C.hooks.run("before-tokenize", a),
                                    ...
                                    for (var o in t)
                                        if (t.hasOwnProperty(o) && t[o]) {
                                            ...
                                            for (var u = 0; u < l.length; ++u) {
                                                ...
                                                c = c.pattern || c;
                                                for (var b = a, y = r; b < n.length; y += n[b].length,
                                                ++b) {
                                                    var w = n[b];
                                                    ...
                                                    if (!(w instanceof O)) {
                                                        if (g && b != n.length - 1) {
                                                            ...
                                                            !(P = c.exec(e)))
                                                                break;
                                                            for (var v = P.index + (p && P[1] ? P[1].length : 0), k = P.index + P[0].length, x = b, _ = y, F = n.length; x < F && (_ < k || !n[x].type && !n[x - 1].greedy); ++x)
                                                                (_ += n[x].length) <= v && (++b,
                                                                y = _);
                                                            if (n[b]instanceof O)
                                                                continue;
                                ...
                                tokenize: function(e, n) {
                                    ...
                                    return C.matchGrammar(e, t, n, 0, 0, !1),
                                    t
                                },
                                hooks: {
                                    all: {},
                            ...
                            !u.document)
                                return u.addEventListener && (C.disableWorkerMessageHandler || u.addEventListener("message", function(e) {
                                    var n = JSON.parse(e.data)
                                      ...
                                      , a = n.code
                                      , r = n.immediateClose;
                                    u.postMessage(C.highlight(a, C.languages[t], t)),
                                    r && u.close()
                                }, !1)),
                                C;
                            ...
                            !C.manual) {
                                ...
                                "loading" === a || "interactive" === a && e && e.defer ? document.addEventListener("DOMContentLoaded", t) : window.requestAnimationFrame ? window.requestAnimationFrame(t) : window.setTimeout(t, 16)
                            }
                            return C
                                ...
                                if (a.language === r) {
                                    ...
                                    a.code = a.code.replace(e, function(e) {
                                        if ("function" == typeof i && !i(e))
                                            return e;
                                        for (var n, t = s.length; -1 !== a.code.indexOf(n = b(r, t)); )
                                            ++t;
                                        return s[t] = e,
                                        n
                                    }),
    ...
    var w = b.exports.boltExport
      ...
      , x = function(i) {
        var e, t, n = i.getParam("codesample_languages") || [{
            text: "HTML/XML",
            value: "markup"
        }, {
            text: "JavaScript",
            ...
            text: "C++",
            value: "cpp"
        }], a = (0 === (e = n).length ? d.none() : d.some(e[0])).fold(function() {
            return ""
        }, function(e) {
            return e.value
        }), r = (t = a,
      ...
      , _ = function(a) {
        a.ui.registry.addToggleButton("codesample", {
            ...
            onSetup: function(t) {
                var e = function() {
                    var e, n;
                    t.setActive((n = (e = a).selection.getStart(),
        ...
        r.add("codesample", function(n) {
            ...
            t.on("PreProcess", function(e) {
                r("pre[contenteditable=false]", e.node).filter(m(g)).each(function(e, n) {
                    ...
                    t.empty().append(r("<code></code>").each(function() {
                        this.textContent = a
                    }))
                })
            }),
