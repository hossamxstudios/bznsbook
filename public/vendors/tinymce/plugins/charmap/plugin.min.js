...
!function(s) {
    "use strict";
    var e, n, r, t, a = tinymce.util.Tools.resolve("tinymce.PluginManager"), l = function(e, n) {
        var r, t = (r = n,
        e.fire("insertCustomChar", {
            chr: r
        }).chr);
        e.execCommand("mceInsertContent", !1, t)
    }, i = tinymce.util.Tools.resolve("tinymce.util.Tools"), o = function(e) {
        return function() {
            return e
        }
    }, c = o(!1), u = o(!0), g = function() {
        return m
    }, m = (e = function(e) {
        return e.isNone()
    }
    ...
    function(e) {
        return r = typeof (n = e),
        (null === n ? "null" : "object" == r && (Array.prototype.isPrototypeOf(n) || n.constructor && "Array" === n.constructor.name) ? "array" : "object" == r && (String.prototype.isPrototypeOf(n) || n.constructor && "String" === n.constructor.name) ? "string" : r) === t;
        var n, r
    }
    ), p = Array.prototype.push, y = function(e, n) {
    ...
    }, b = i.isArray, k = "User Defined", C = function(e) {
        return b(e) ? [].concat((n = e,
        i.grep(n, function(e) {
        ...
        var n = function(e, n) {
            ...
            if (t) {
                ...
                return a.length ? (a[0].characters = [].concat(a[0].characters).concat(C(t)),
                n) : [].concat(n).concat({
                    name: k,
                    characters: C(t)
                })
    ...
    }, O = String.fromCodePoint, q = function(e, n) {
        ...
        for (var r = [], t = "", a = 0, i = e.length; a !== i; ++a) {
            ...
            16383 <= (o <= 65535 ? r.push(o) : (o -= 65536,
            r.push(55296 + (o >> 10), o % 1024 + 56320))) && (t += String.fromCharCode.apply(null, r),
            r.length = 0)
        }
        ...
        return function(e, n) {
            ...
            r = e[1],
            t = i,
            (q(S(n).toLowerCase(), t) || q(r.toLowerCase(), t) || q(r.toLowerCase().replace(/\s+/g, ""), t)) && a.push(e)
        }),
        y(a, function(e) {
            return {
                text: e[1],
        ...
        }, c = 1 === a.length ? A(k) : A("All"), u = (t = function(e) {
    ...
    }, I = tinymce.util.Tools.resolve("tinymce.util.Promise");
    !function N() {
        a.add("charmap", function(e) {
            var n, r, t, a, i, o, c = x(e);
            return r = c,
