...
!function() {
    ...
    ,
    {
    ...
    }, S = tinymce.util.Tools.resolve("tinymce.util.Tools"), _ = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), k = tinymce.util.Tools.resolve("tinymce.html.SaxParser"), A = function(e, t) {
        if (e)
            ...
            start: function(e, t) {
                if (!c.get())
                    if (j(t.map, "data-ephox-embed-iri"))
                        ...
                        if (u.source || "param" !== e || (u.source = t.map.movie),
                        "iframe" !== e && "object" !== e && "embed" !== e && "video" !== e && "audio" !== e || (u.type || (u.type = e),
                        u = S.extend(t.map, u)),
                        "script" === e) {
                            var r = A(o, t.map.src);
                            if (!r)
        ...
        return t || ""
    }, $ = tinymce.util.Tools.resolve("tinymce.html.Schema"), F = tinymce.util.Tools.resolve("tinymce.html.Writer"), M = _.DOM, z = function(e) {
        ...
        !function(e, t) {
            ...
            if (a.map[t])
                for (var n = a.length; n--; ) {
                    var i = a[n];
                    i.name === t && (r ? (a.map[t] = r,
                    i.value = r) : (delete a.map[t],
                    a.splice(n, 1)))
                }
            else
                r && (a.push({
            ...
            start: function(e, t, r) {
                if (!m.get())
                    if (j(t.map, "data-ephox-embed-iri"))
                        ...
                        case "img":
                        case "iframe":
                            c.height !== undefined && c.width !== undefined && N(t, {
                                width: c.width,
                                height: c.height
                            })
                        }
        ...
        return 0 < e.length ? S.extend({}, e[0], {
            url: function(e, t) {
                for (var r, n = (r = t.match(/^(https?:\/\/|www\.)(.+)$/i)) && 1 < r.length && "www." !== r[1] ? r[1] : "https://", i = e.regex.exec(t), a = n + e.url, o = function(e) {
        ...
        var n = S.extend({}, e);
        if (!n.source && (S.extend(n, P(O(r), n.embed)),
        !n.source))
            return "";
        ...
        var a, o, c, u, s, l, m, d, h = r.getParam("audio_template_callback"), f = r.getParam("video_template_callback");
        return n.width = n.width || "300",
        n.height = n.height || "150",
        S.each(n, function(e, t) {
            n[t] = r.dom.encode("" + e)
        }),
        "iframe" === n.type ? (d = (m = n).allowFullscreen ? ' allowFullscreen="1"' : "",
        '<iframe src="' + m.source + '" width="' + m.width + '" height="' + m.height + '"' + d + "></iframe>") : "application/x-shockwave-flash" === n.sourcemime ? (l = '<object data="' + (s = n).source + '" width="' + s.width + '" height="' + s.height + '" type="application/x-shockwave-flash">',
        s.poster && (l += '<img src="' + s.poster + '" width="' + s.width + '" height="' + s.height + '" />'),
        l += "</object>") : -1 !== n.sourcemime.indexOf("audio") ? (c = n,
        (u = h) ? u(c) : '<audio controls="controls" src="' + c.source + '">' + (c.altsource ? '\n<source src="' + c.altsource + '"' + (c.altsourcemime ? ' type="' + c.altsourcemime + '"' : "") + " />\n" : "") + "</audio>") : "script" === n.type ? '<script src="' + n.source + '"><\/script>' : (a = n,
        (o = f) ? o(a) : '<video width="' + a.width + '" height="' + a.height + '"' + (a.poster ? ' poster="' + a.poster + '"' : "") + ' controls="controls">\n<source src="' + a.source + '"' + (a.sourcemime ? ' type="' + a.sourcemime + '"' : "") + " />\n" + (a.altsource ? '<source src="' + a.altsource + '"' + (a.altsourcemime ? ' type="' + a.altsourcemime + '"' : "") + " />\n" : "") + "</video>")
        ...
        new q(function(t, e) {
            var r = function(e) {
                return e.html && (B[i.source] = e),
                t({
                    url: i.source,
                    html: e.html ? e.html : a(i)
                })
            };
            B[i.source] ? r(B[i.source]) : o({
                url: i.source
            }, r, e)
        }
        )) : (r = t,
        ...
        return function(e) {
            ...
            return (t = {})[e] = (e === c ? r().bind(function(e) {
                return h(e) ? i(e).orThunk(n) : n().orThunk(function() {
                    return l.from(e)
                })
            }) : n().orThunk(function() {
        ...
        return p(p(p(p(p({}, a("source")), a("altsource")), a("poster")), a("embed")), (r = i,
        n = {},
        ...
        var n = p(p({}, e), {
            source: {
                value: x(e, "source").getOr("")
            },
            altsource: {
                value: x(e, "altsource").getOr("")
            },
            poster: {
                value: x(e, "poster").getOr("")
            }
        });
        ...
        var n;
        t.embed = E(t.embed, t),
        t.embed && (e.source === t.source || (n = t.source,
        B.hasOwnProperty(n))) ? Y(r, t.embed) : G(r, t).then(function(e) {
            Y(r, e.html)
        })["catch"](Q(r))
    }, ee = function(m) {
        var e, t, r, n, i = (r = (e = m).selection.getNode(),
        n = (t = r).getAttribute("data-mce-object") || t.getAttribute("data-ephox-embed-iri") ? e.serializer.serialize(r, {
            selection: !0
        }) : "",
        p({
            embed: n
        }, P(O(e), n))), d = w(i), a = K(i), o = {
            title: "General",
            name: "general",
            items: function(e) {
    ...
    }, te = tinymce.util.Tools.resolve("tinymce.html.Node"), re = tinymce.util.Tools.resolve("tinymce.Env"), ne = function(a, e) {
        if (!1 === a.getParam("media_filter_html", !0))
            return e;
        var o, c = F();
        return k({
            validate: !1,
        ...
        var a = new te("span",1);
        return a.attr("class", "mce-shim"),
        n.append(i),
        n.append(a),
        n
    }, ae = function(e, t, r) {
        var n, i, a, o = t.attributes;
        for (a = o.length; a--; )
            n = o[a].name,
            i = o[a].value,
            "width" !== n && "height" !== n && "style" !== n && ("data" !== n && "src" !== n || (i = e.convertURL(i, n)),
            r.attr("data-mce-p-" + n, i));
        var c = t.firstChild && t.firstChild.value;
        c && (r.attr("data-mce-html", escape(ne(e, c))),
        r.firstChild = null)
    }, oe = function(e) {
        for (; e = e.parent; )
        ...
        return function(e) {
            for (var t, r, n, i, a, o, c = e.length; c--; )
                (t = e[c]).parent && (t.parent.attr("data-mce-object") || "script" === t.name && !(r = A(O(u), t.attr("src"))) || (r && (r.width && t.attr("width", r.width.toString()),
                r.height && t.attr("height", r.height.toString())),
                "iframe" === t.name && u.getParam("media_live_embeds", !0) && re.ceFalse ? oe(t) || t.replace(ie(u, t)) : oe(t) || t.replace((n = u,
                o = void 0,
                a = (i = t).name,
    ...
    !function se() {
        n.add("media", function(e) {
            ...
            (d = e).on("preInit", function() {
                ...
                d.parser.addNodeFilter("iframe,video,audio,object,embed,script", ce(d)),
                d.serializer.addAttributeFilter("data-mce-object", function(e, t) {
                    for (var r, n, i, a, o, c, u, s, l = e.length; l--; )
                        if ((r = e[l]).parent) {
                            for (u = r.attr(t),
                            n = new te(u,1),
                            "audio" !== u && "script" !== u && ((s = r.attr("class")) && -1 !== s.indexOf("mce-preview-object") ? n.attr({
                            ...
                            (o = r.attr("data-mce-html")) && ((c = new te("#text",3)).raw = !0,
            ...
            r.on("ObjectResized", function(e) {
                ...
                r.setAttribute("data-mce-html", escape(E(t, {
