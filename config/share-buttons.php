...
return [
    ...
    */
    ...
    'templates' => [
        'bluesky' => '<a href=":url" class="social-button:class":id:title:rel><i class="bi bi-square"></i></a>',
        'copylink' => '<a href=":url" class="social-button:class" id="clip":title:rel><i class="bi bi-share"></i></a>',
        'evernote' => '<a href=":url" class="social-button:class":id:title:rel><i class="bi bi-journal-text"></i></a>',
        'facebook' => '<a href=":url" class="social-button:class":id:title:rel><i class="bi bi-facebook"></i></a>',
        'linkedin' => '<a href=":url" class="social-button:class":id:title:rel><i class="bi bi-linkedin"></i></a>',
        'whatsapp' => '<a href=":url" class="social-button:class":id:title:rel><i class="bi bi-whatsapp"></i></a>',
        'telegram' => '<a href=":url" class="social-button:class":id:title:rel><i class="bi bi-telegram"></i></a>',
