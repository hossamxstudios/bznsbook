<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasTopLabel" style="width:570px;">
    <div class="offcanvas-header" style="background: #474e5d;">
        <h5 id="offcanvasRightLabel" style="color:aliceblue">Create Contact</h5>
        ...
        <form action="{{ route('contacts.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter contact phone number" required>
                </div>
            </div>
            <div class="mb-3">
                <label for="title" class="form-label">Job Title</label>
                <input type="text" class="form-control" id="title" name="title" placeholder="Enter contact title (e.g., Manager)">
            </div>
            <div class="mb-3">
