    ...
    <div>
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-wrap justify-content-between flex-1">
                <div class="d-flex align-items-center">
                    <h5 class="pg-title fs-5 mb-0 d-flex align-items-center">{{ x_('Deals', 'deals') }}<span class="d-flex task-star marked ms-2"><span class="feather-icon"></span></span>
                    </h5>
                ...
                <div class="pg-header-action-wrap position-relative">
                    <span style="padding: 0 8px 0 0;">{{ x_('New Deal', 'deals') }}</span>
                    <div class="d-flex ms-auto align-items-center">
                        <div class="avatar-group avatar-group-overlapped d-xl-flex d-none me-3">
                            <div class="avatar avatar-icon  avatar-rounded cursor-pointer"  data-bs-placement="top" title="" data-bs-original-title="{{ x_('Add new deal', 'deals') }}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAdd">
        ...
        <ul class="nav nav-tabs nav-icon nav-icon nav-light mt-3">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#tab_block_1">
                    ...
                    <span class="nav-link-text">{{ x_('Deals Board view', 'deals') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab_block_2">
                    ...
                    <span class="nav-link-text">{{ x_('Deals Table view', 'deals') }}</span>
                </a>
            </li>
            {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab_block_4">
                    ...
                    <span class="nav-link-text">{{ x_('Edit pipeline', 'deals') }}</span>
                </a>
            </li> --}}
        </ul>
    </div>
