<div class="modal fade" id="expireModal{{ $subscription->id }}" tabindex="-1" role="dialog" aria-labelledby="expireModalLabel{{ $subscription->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="expireModalLabel{{ $subscription->id }}">{{ x_('Expire Subscription', 'admin') }}</h5>
            ...
            <form action="{{ route('admin.subscriptions.toggle.active') }}" method="POST">
                ...
                <div class="modal-body">
                    <p>{{ x_('Are you sure you want to expire this subscription?', 'admin') }}</p>
