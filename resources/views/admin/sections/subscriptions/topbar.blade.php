    ...
    <div>
        <div class="d-flex align-items-center">
            ...
            <div class="avatar avatar-sm avatar-icon avatar-info me-3">
                <span class="initial-wrap rounded-8"><span class="svg-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-crown" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <ul class="mt-3 nav nav-tabs nav-icon nav-light">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab_expired">
                    <span class="nav-icon-wrap"><span class="svg-icon">
