    ...
    <div>
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-wrap justify-content-between flex-1">
                <div>
                    <div class="pg-subtitle">{{ x_('Overview', 'roles') }} </div>
                    <h5 class="pg-title fs-5">{{ x_('Roles Board', 'roles') }}</h5>
                </div>
                <div class="pg-header-action-wrap position-relative">
                    <div class="d-md-flex d-none ms-auto align-items-center">
                        <button class="btn btn-custom btn-white text-primary btn-floating rounded-8 ms-3" onclick="window.location.href='{{ route('roles.add') }}'">
                            <span>
                                ...
                                <span class="fs-7">{{ x_('Add New Role', 'roles') }}</span>
                            </span>
                        </button>
                    </div>
                </div>
        ...
        <ul class="nav nav-tabs nav-line nav-icon nav-light mt-3">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#tab_boards">
                    ...
                    <span class="nav-link-text">{{ x_('All Roles', 'roles') }}</span>
                </a>
            </li>
        </ul>
    </div>
