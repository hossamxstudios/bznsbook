                ...
                <div class="col-md-12 mb-md-4 mb-3">
                    <div class="card rounded-8 mb-0" style="height: 90vh!important;">
                        <div class="card-header card-header-action">
                            <h6>{{ x_('Edit Role and Permissions', 'roles') }}</h6>
                        </div>
                        <div class="card-body">
                            <div class="role-list-view">
                                <form action="{{ route('roles.update',['id',$role->id]) }}" method="POST">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control mb-5" placeholder="{{ x_('Enter Role Name', 'roles') }}" value="{{ $role->name }}">
                                    <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{ x_('Update Role', 'roles') }}</button>
                                </form>
                            </div>
                        </div>
                    </div>
