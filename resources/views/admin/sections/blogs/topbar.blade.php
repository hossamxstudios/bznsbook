        ...
        <div class="d-flex align-items-center">
            ...
            <div class="flex-wrap flex-1 d-flex justify-content-between">
                <div>
                    ...
                    <h5 class="pg-title fs-5">{{ x_('Blogs Board', 'blogs') }}</h5>
                </div>
                    ...
                    <div class="d-md-flex d-none ms-auto align-items-center">
                        <button class="btn btn-custom btn-white text-primary btn-floating rounded-8 ms-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAdd" >
                            <span>
                                ...
                                <span class="fs-7">{{ x_('Add New Blog', 'blogs') }}</span>
                            </span>
                        </button>
                    </div>
                </div>
        ...
        <ul class="mt-3 nav nav-tabs nav-icon nav-light">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#tab_boards">
                    ...
                    <span class="nav-link-text">{{ x_('All Blogs', 'blogs') }}</span>
                </a>
            </li>
            {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab_team">
                    ...
                    <span class="nav-link-text">{{ x_('Team Members', 'blogs') }}</span>
                </a>
            </li> --}}
        </ul>
    </div>
