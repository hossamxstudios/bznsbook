    ...
    <div>
        <div class="d-flex align-items-center">
            ...
            <div class="avatar avatar-sm avatar-icon avatar-info me-3">
                <span class="initial-wrap rounded-8"><span class="svg-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-box-multiple" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="d-flex flex-wrap justify-content-between flex-1">
                <div>
                    <div class="pg-subtitle">
                        {{ x_('Overview', 'companies') }}
                    </div>
                    <h5 class="pg-title fs-5">{{ x_('Recruitment Clients Board', 'companies') }}</h5>
                </div>
                <div class="pg-header-action-wrap position-relative">
                    <div class="d-md-flex d-none ms-auto align-items-center">
                        <button class="btn btn-custom btn-white text-primary btn-floating rounded-8 ms-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAdd" >
                            <span>
                                ...
                                <span class="fs-7">
                                        {{ x_('Add new Recruitment Client', 'companies') }}
                                </span>
                            </span>
                        </button>
                        {{-- <button class="btn btn-custom btn-white text-primary btn-floating rounded-8 ms-3" data-bs-toggle="modal" data-bs-target="#uploadExcelModal">
                            <span>
                                ...
                                <span class="fs-7">{{ x_('Bulk Upload', 'companies') }}</span>
                            </span>
                        </button> --}}
                    </div>
                </div>
        ...
        <ul class="nav nav-tabs nav-icon nav-icon nav-light mt-3">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#tab_boards">
                    ...
                    <span class="nav-link-text">{{ x_('All Recruitment Clients', 'companies') }}</span>
                </a>
            </li>
            {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab_team">
                    ...
                    <span class="nav-link-text">{{ x_('Team Members', 'companies') }}</span>
                </a>
            </li> --}}
        </ul>
    </div>
