    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="uploadExcelModalLabel">{{ x_('Upload Excel Files', 'admin') }}</h5>
            ...
            <form action="{{ route('companies.bulkImport') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="file" class="form-label">{{ x_('Choose Excel File', 'admin') }}</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">{{ x_('Upload', 'admin') }}</button>
                </div>
            </form>
        </div>
    </div>
