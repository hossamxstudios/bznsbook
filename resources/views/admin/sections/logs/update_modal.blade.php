<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasUpdate{{ $deal->id }}"
    ...
    <div class="offcanvas-header" style="background: #474e5d;">
        <h5 id="offcanvasUpdateLabel{{ $deal->id }}" style="color: aliceblue;">{{ x_('Update Deal', 'admin') }}</h5>
    ...
    <div class="offcanvas-body">
        <form id="updateDealForm{{ $deal->id }}" action="{{ route('deals.update', $deal->id) }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="update_pipeline_id_{{ $deal->id }}" class="form-label">{{ x_('Pipeline', 'admin') }}</label>
            ...
            <div class="mb-3">
                <label for="update_stage_id_{{ $deal->id }}" class="form-label">{{ x_('Stage', 'admin') }}</label>
            ...
            <div class="mb-3">
                <label for="update_company_id_{{ $deal->id }}" class="form-label">{{ x_('Company', 'admin') }}</label>
            ...
            <div class="mb-3">
                <label for="update_contact_id_{{ $deal->id }}" class="form-label">{{ x_('Contact', 'admin') }}</label>
