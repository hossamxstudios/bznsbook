                ...
                <div class="taskboardapp-wrap">
                    <div class="taskboardapp-content">
                        <div class="taskboardapp-detail-wrap">
                            @include('admin.sections.tags.topbar')
                            @include('admin.sections.tags.table')
                        </div>
                        @include('admin.sections.tags.add_modal')
                        @foreach ($tags as $tag)
                            @include('admin.sections.tags.update_modal')
                            @include('admin.sections.tags.delete_modal')
                        @endforeach
                    </div>
                </div>
            </div>
