            ...
            <div class="py-5 text-center">
                ...
                <div class="mx-auto parallax d-dark-mode-none" style="max-width: 574px;">
                    <div class="parallax-layer" data-depth="-0.15">
                        <img src="{{ asset('assets/img/404/light/layer01.png') }}" alt="{{ x_('Layer', 'general') }}">
                    </div>
                    <div class="parallax-layer" data-depth="0.12">
                        <img src="{{ asset('assets/img/404/light/layer02.png') }}" alt="{{ x_('Layer', 'general') }}">
                    </div>
                    <div class="parallax-layer zindex-5" data-depth="-0.12">
                        <img src="{{ asset('assets/img/404/light/layer03.png') }}" alt="{{ x_('Layer', 'general') }}">
                    </div>
                </div>
                ...
                <div class="mx-auto parallax d-none d-dark-mode-block" style="max-width: 574px;">
                    <div class="parallax-layer" data-depth="-0.15">
                        <img src="{{ asset('assets/img/404/dark/layer01.png') }}" alt="{{ x_('Layer', 'general') }}">
                    </div>
                    <div class="parallax-layer" data-depth="0.12">
                        <img src="{{ asset('assets/img/404/dark/layer02.png') }}" alt="{{ x_('Layer', 'general') }}">
                    </div>
                    <div class="parallax-layer zindex-5" data-depth="-0.12">
                        <img src="{{ asset('assets/img/404/dark/layer03.png') }}" alt="{{ x_('Layer', 'general') }}">
                    </div>
                </div>

                <h1 class="visually-hidden">404</h1>
                <h2 class="display-5">{{ x_('Ooops!', 'general') }}</h2>
                <p class="pb-3 fs-xl pb-md-0 mb-md-5">{{ x_('The page you are looking for is not available.', 'general') }}</p>
