    ...
    <div data-simplebar class="nicescroll-bar" id="tab_1">
        <div class="container-fluid px-5 pt-5">
            <div class="d-flex justify-content-between align-items-center mb-5">
                <h5 class="mb-0">{{ x_('Dashboard', 'general') }}</h5>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 mb-md-0 mb-4">
                            <div class="card card-flush rounded-8 mb-0 h-100">
                                <div class="card-body">
                                    <h3>{{$startDate}}</h3>
                                    <span class="d-inline-flex">{{ x_('Start Date', 'general') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 mb-md-0 mb-4">
                            <div class="card card-flush rounded-8 mb-0 h-100">
                                <div class="card-body">
                                    <h3>{{$endDate}}</h3>
                                    <span class="d-inline-flex">{{ x_('End Date', 'general') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="card card-flush rounded-8 mb-0 h-100">
                                <div class="card-body">
                                    ...
                                    <span class="d-inline-flex">{{ x_('All Candidates', 'general') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-md-4 mb-3">
                    <div class="card card-flush card-simple rounded-8 mb-0">
                        <div class="card-header card-header-action">
                            <h6>{{ x_('Latest Candidates', 'general') }}</h6>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="contact-list-view">
                                <table id="datable_11" class="table wrap w-100 mb-5">
                                    <thead>
                                        <tr>
                                            <th class="w-50">{{ x_('Title', 'general') }}</th>
                                            <th class="w-50">{{ x_('Comapny', 'general') }}</th>
                                            <th class="w-50">{{ x_('Applications', 'general') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
