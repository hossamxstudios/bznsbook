        ...
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-wrap justify-content-between flex-1">
                <div>
                    ...
                    <h5 class="pg-title fs-5">{{ x_('Jobs Board', 'general') }}</h5>
                </div>
                <div class="pg-header-action-wrap position-relative">
                    <div class="d-md-flex d-none ms-auto align-items-center">
                        <button class="btn btn-custom btn-white text-primary btn-floating rounded-8 ms-3"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddd" >
                            <span>
        ...
        <ul class="nav nav-tabs nav-line nav-icon nav-light mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link " data-bs-toggle="tab" href="#accepted">
                    ...
                    <span class="nav-link-text"> {{ x_('Accepted Jobs', 'general') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#requests">
                    ...
                    <span class="nav-link-text">{{ x_('Job Requests', 'general') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " data-bs-toggle="tab" href="#rejected">
                    ...
                    <span class="nav-link-text">{{ x_('All Rejected Requests', 'general') }}</span>
                </a>
            </li>
        </ul>
    </div>
