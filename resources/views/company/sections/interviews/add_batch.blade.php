    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addBatchLabel{{$job->id}}">{{ x_('Add Batch', 'general') }}</h5>
            ...
            <form action="{{ route('jobs.batch.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">{{ x_('Batch Details (if exists)', 'general') }}</label>
                        <textarea class="form-control" name="details" rows="3" required></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">{{ x_('Batch Size *', 'general') }}</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">{{ x_('Save Batch', 'general') }}</button>
                </div>
            </form>
        </div>
    </div>
