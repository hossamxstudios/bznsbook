              ...
              <div class="position-relative">
                ...
                <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center rounded-3">
                  ...
                  <div class="position-relative d-flex zindex-2">
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-facebook btn-sm me-2" aria-label="Facebook">
                      <i class="bx bxl-facebook"></i>
                    </a>
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-linkedin btn-sm me-2" aria-label="LinkedIn">
                      <i class="bx bxl-linkedin"></i>
                    </a>
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-twitter btn-sm" aria-label="Twitter">
              ...
              <div class="position-relative">
                ...
                <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center rounded-3">
                  ...
                  <div class="position-relative d-flex zindex-2">
                    ...
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-dribbble btn-sm me-2" aria-label="Dribbble">
                      <i class="bx bxl-dribbble"></i>
                    </a>
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-linkedin btn-sm" aria-label="LinkedIn">
                      <i class="bx bxl-linkedin"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="position-relative">
                ...
                <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center rounded-3">
                  ...
                  <div class="position-relative d-flex zindex-2">
                    ...
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-twitter btn-sm me-2" aria-label="Twitter">
                      <i class="bx bxl-twitter"></i>
                    </a>
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-linkedin btn-sm" aria-label="LinkedIn">
                      <i class="bx bxl-linkedin"></i>
              ...
              <div class="position-relative">
                ...
                <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center rounded-3">
                  ...
                  <div class="position-relative d-flex zindex-2">
                    ...
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-behance btn-sm me-2" aria-label="Behance">
                      <i class="bx bxl-behance"></i>
                    </a>
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-dribbble btn-sm" aria-label="Dribbble">
                      <i class="bx bxl-dribbble"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="position-relative">
                ...
                <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center rounded-3">
                  ...
                  <div class="position-relative d-flex zindex-2">
                    ...
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-behance btn-sm" aria-label="Behance">
                      <i class="bx bxl-behance"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="position-relative">
                ...
                <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center rounded-3">
                  ...
                  <div class="position-relative d-flex zindex-2">
                    ...
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-stack-overflow btn-sm me-2" aria-label="Stack Overflow">
                      <i class="bx bxl-stack-overflow"></i>
                    </a>
                    <a href="#" class="bg-white btn btn-icon btn-secondary btn-github btn-sm" aria-label="GitHub">
