    ...
    <div class="container">
        <div class="py-5 row align-items-center justify-content-center my-sm-2 my-xxl-3">
            <div class="pb-4 mb-2 col-10 col-sm-9 col-md-6 pb-md-0 mb-md-0">
                <!-- Swiper tabs -->
                <div class="mx-auto swiper-tabs zindex-2">
                    <div id="screen-1" class="px-4 swiper-tab rounded-3 px-sm-5 px-md-0 active" style="background: linear-gradient(135deg, #a2a2a2 0%, #0f0f0f 100%);">
            ...
            <div class="col-md-6 col-lg-5 offset-lg-1">
                <div class="ps-md-4 ps-lg-0">
                    <!-- Swiper slider -->
                    <div class="mt-auto text-center swiper text-md-start"
                    ...
                    <div class="pt-2 d-flex justify-content-center justify-content-md-start pt-lg-3">
                        <button type="button" id="prev-screen" class="btn btn-prev btn-icon btn-sm"
                            aria-label="Previous">
                            <i class="bx bx-chevron-left"></i>
                        </button>
                        <div id="stepsPagination"
                            class="bottom-0 mx-3 swiper-pagination position-relative fs-sm lh-1 fw-medium"
                            style="width: 1.5rem;"></div>
                        <button type="button" id="next-screen" class="btn btn-next btn-icon btn-sm"
                            aria-label="Next">
