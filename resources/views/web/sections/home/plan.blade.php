     ...
     <div class="pt-5 row pb-md-3">
         ...
         <div class="col-xl-6 col-lg-7 offset-xl-1 position-relative">
             ...
             <div class="position-relative">
                 <div class="overflow-hidden px-4 py-5 position-relative bg-gradient-primary rounded-3 zindex-5 p-sm-5">
                     <span class="p-4 position-absolute top-50 start-0 translate-middle bg-light rounded-circle"></span>
                     <span class="top-0 position-absolute start-0 w-100 h-100 bg-repeat-0 bg-position-center-end bg-size-cover" style="background-image: url(assets/img/landing/conference/price-card-pattern.png);"></span>
                     ...
                     <span
                         class="p-4 position-absolute top-50 end-0 translate-middle-y bg-light rounded-circle me-n4"></span>
                 </div>
                 <span class="bottom-0 opacity-60 position-absolute bg-gradient-primary mb-n2 d-dark-mode-none"
                     style="left: 1.5rem; width: calc(100% - 3rem); height: 5rem; filter: blur(.625rem);"></span>
             </div>

             <!-- Arrow -->
             <div class="bottom-0 pb-3 position-absolute text-primary d-none d-lg-block ms-xl-n5 mb-lg-5 mb-xl-4">
                 <div class="ms-xl-n4">
