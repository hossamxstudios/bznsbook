        ...
        <div class="d-flex align-items-center">
            ...
            <form action="/" method="GET" id="dateFilterForm">
                <div class="d-flex flex-wrap justify-content-between flex-1">
                    <div class="d-flex align-items-center">
                        <h5 class="pg-title fs-5 mb-0 d-flex align-items-center">{{ x_('Dashboard', 'home') }}<span class="d-flex task-star marked ms-2"><span class="feather-icon"></span></span></h5>
                        ...
                        <div class="ms-3 d-xl-flex d-none">
                            <input type="submit" name="submit" class="btn btn-danger" value="{{ x_('Search', 'home') }}">
                        </div>
                    </div>
        ...
        <ul class="nav nav-tabs nav-icon nav-icon nav-light mt-3">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#tab_block_1">
                    ...
                    <span class="nav-link-text">{{ x_('Overview', 'home') }}</span>
                </a>
            </li>
        </ul>
    </div>
