...
<div class="col-md-8 mb-lg-4 pt-md-5 mt-n3 mt-md-0">
    <div class="ps-md-3 ps-lg-0 mt-md-2 8">
        <div class="alert alert-info">
            <h5 class="alert-heading"><i class="bx bx-info-circle me-2"></i>{{ x_('Projects Have Moved!', 'web') }}</h5>
            <p>{{ x_('Our project management system has been upgraded with new features. You are being redirected to the new project dashboard...', 'web') }}</p>
            <hr>
            <p class="mb-0">{{ x_('If you are not redirected automatically, please', 'web') }} <a href="{{ route('client.projects.applications') }}" class="alert-link">{{ x_('click here', 'web') }}</a>.</p>
        </div>
        <script>
