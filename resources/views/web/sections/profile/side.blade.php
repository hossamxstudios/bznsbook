  ...
  <div class="top-0 position-sticky">
    <div class="pt-5 text-center">
      ...
      <div id="account-menu" class="list-group list-group-flush collapse d-md-block">
        ...
        {{-- <a href="{{ route('client.projects.create') }}" class="list-group-item list-group-item-action d-flex align-items-center @if(request()->is('client/projects/create')) active @endif">
